...
namespace DWSIM.UI.Desktop.Shared.Controls
{
    public static class ProgressDialog
    {
        ...
        public static Dialog ShowWithAbort(Control owner, string message1, string message2, bool modal, string abortText, Action<Button, EventArgs> abortCommand)
        {
            ...
            var btnAbort = new Button { Text = abortText, Height = 30 };

            if (abortCommand != null) btnAbort.Click += (sender, e) => abortCommand.Invoke((Button)sender, e);

            var row1 = new TableLayout { Rows = { new TableRow(null, progressSpinner, null), null } };
            var container = new TableLayout { Rows = { row1, loadingtext, loadingtext2, btnAbort, null }, Spacing = new Size(5, 5), Padding = new Padding(25, 10, 25, 10) };
