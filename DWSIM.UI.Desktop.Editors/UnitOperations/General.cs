        ...
        void Initialize()
        {
            ...
            switch (SimObject.GraphicObject.ObjectType)
            {
                ...
                case ObjectType.RCT_Equilibrium:
                    ...
                    s.CreateAndAddCheckBoxRow(container, "Alternate Initialization", reactor2.AlternateInitialization, (sender, e) => reactor2.AlternateInitialization = sender.Checked.GetValueOrDefault(), () => CallSolverIfNeeded());
