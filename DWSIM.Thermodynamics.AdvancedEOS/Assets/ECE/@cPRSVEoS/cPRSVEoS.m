...
this = struct( ...
    'mID', 'Peng-Robinson Stryjek-Vera');        %EoS ID
	
this = class(this,'cPRSVEoS',ParentEoS);

this.cPREoS.ID = 'Peng-Robinson Stryjek-Vera';