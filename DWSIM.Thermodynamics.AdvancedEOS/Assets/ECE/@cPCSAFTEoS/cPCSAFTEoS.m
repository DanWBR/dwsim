function this = cPCSAFTEoS(varargin)
%Constructor of the cPCSAFTEoS class
%This class implements the PC-SAFT EoS
...
this = class(this,'cPCSAFTEoS',ParentEoS);

this.cSAFTEoS.ID = 'PC-SAFT';