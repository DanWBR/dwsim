%This example shows the calculation of a T-xy diagram of a mixture
...
%In order to calculate the Txy diagram, an estimation of the equilibrium
...
[T,x,y,handle,EoS] = TxyDiagram(EoS,mix,343,1e5,[1 0]);
...
[T,x,y,handle,EoS] = TxyDiagram(EoS,mix,343,1e5,[1 0],100,[0 1],1);