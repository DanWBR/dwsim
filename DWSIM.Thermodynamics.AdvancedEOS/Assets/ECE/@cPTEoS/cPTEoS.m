function this = cPTEoS(varargin)
%Constructor of the cPTEoS class
%This class implements the Patel-Teja EoS with Van der Waals quadratic
...
this = struct( ...
    'mID', 'Patel-Teja');        %EoS ID
	
this = class(this,'cPTEoS',ParentEoS);

this.cIdealEoS.ID = 'Patel-Teja';