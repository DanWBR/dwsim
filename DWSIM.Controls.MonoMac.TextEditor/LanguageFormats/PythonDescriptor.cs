...
{
    /// <summary>
    /// Defines how Python should be colorized using a <see cref="AppKit.TextKit.Formatter.LanguageFormatter"/>.
    /// </summary>
    public class PythonDescriptor : LanguageDescriptor
    {
        ...
        public override char[] LanguageSeparators { get; set; }
        #endregion
        ...
        public override void Define()
        {
            ...
            Keywords.Add("def", new KeywordDescriptor(KeywordType.Type, TypeColor, "An implicitly typed local variable is strongly typed just as if you had declared the type yourself, but the compiler determines the type."));
