...
Final2:
    ...
    <System.Serializable()> Public Class Methods_PR78
...
Final2:
        ...
        Function QIJ_HES_MAT(ByVal T, ByVal V, ByVal Vz, ByVal VTc, ByVal VPc, ByVal VVc, ByVal Vw, ByVal VKIj) As Mapack.Matrix
            ...
            Do
                If Vz(i) <> 0 Then
                    If w(i) <= 0.491 Then
                        c(i) = 0.37464 + 1.5422 * w(i) - 0.26992 * w(i) ^ 2
                    Else
                        c(i) = 0.379642 + 1.48503 * w(i) - 0.164423 * w(i) ^ 2 + 0.016666 * w(i) ^ 3
                    End If
                    alpha(i) = (1 + c(i) * (1 - (T / Tc(i)) ^ 0.5)) ^ 2
                    ai(i) = 0.45724 * alpha(i) * R ^ 2 * Tc(i) ^ 2 / Pc(i)
                    b(i) = 0.0778 * R * Tc(i) / Pc(i)
                End If
                i = i + 1
