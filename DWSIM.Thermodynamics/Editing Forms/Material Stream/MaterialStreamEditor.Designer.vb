...
Partial Class MaterialStreamEditor
    ...
    Private Sub InitializeComponent()
        ...
        Me.tbReports = New System.Windows.Forms.TextBox()
        ...
        Me.GroupBox5.Controls.Add(Me.btnViewReports)
        Me.GroupBox5.Controls.Add(Me.tbReports)
        ...
        'btnViewReports
        '
        resources.ApplyResources(Me.btnViewReports, "btnViewReports")
        Me.btnViewReports.Image = Global.DWSIM.Thermodynamics.My.Resources.Resources.bullet_green
        Me.btnViewReports.Name = "btnViewReports"
        Me.ToolTipValues.SetToolTip(Me.btnViewReports, resources.GetString("btnViewReports.ToolTip"))
        Me.ToolTipChangeTag.SetToolTip(Me.btnViewReports, resources.GetString("btnViewReports.ToolTip1"))
        Me.btnViewReports.UseVisualStyleBackColor = True
        '
        'tbReports
        '
        resources.ApplyResources(Me.tbReports, "tbReports")
        Me.tbReports.Name = "tbReports"
        Me.tbReports.ReadOnly = True
        Me.ToolTipChangeTag.SetToolTip(Me.tbReports, resources.GetString("tbReports.ToolTip"))
        Me.ToolTipValues.SetToolTip(Me.tbReports, resources.GetString("tbReports.ToolTip1"))
        '
        'Label21
        '
        ...
        Me.ToolTipChangeTag.SetToolTip(Me.cbFlashAlg, resources.GetString("cbFlashAlg.ToolTip"))
    ...
    Public WithEvents tbReports As TextBox
    Public WithEvents Label21 As Label
    Public WithEvents lblStatus As TextBox
    Public WithEvents btnViewReports As Button
End Class
