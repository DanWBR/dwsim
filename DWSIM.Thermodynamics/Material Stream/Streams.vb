...
#Region "    DWSIM Specific"
        ...
        '        .Item.Add(Me.FlowSheet.GetTranslatedString("UOPropertyPackage"), tag, False, Me.FlowSheet.GetTranslatedString("Outros"), "", True)
        ...
        '            .Item.Add("[1] " & Me.FlowSheet.GetTranslatedString("Especificao"), Me, "SpecType", False, Me.FlowSheet.GetTranslatedString("Condies1"), "")
        ...
        '        valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.temperature, Me.Phases(0).Properties.temperature.GetValueOrDefault), FlowSheet.FlowsheetOptions.NumberFormat)
        '        .Item.Add("[2] " & FT(Me.FlowSheet.GetTranslatedString("Temperatura"), su.temperature), valor, True, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("Temperaturadacorrent"), True)
        '        With .Item(.Item.Count - 1)
        ...
        '                    .Tag = New Object() {FlowSheet.FlowsheetOptions.NumberFormat, su.temperature, "T"}
        '            End Select
        '        End With
        '        valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.pressure, Me.Phases(0).Properties.pressure.GetValueOrDefault), FlowSheet.FlowsheetOptions.NumberFormat)
        '        .Item.Add(FT("[3] " & Me.FlowSheet.GetTranslatedString("Presso"), su.pressure), valor, True, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("Pressodacorrente"), True)
        '        With .Item(.Item.Count - 1)
        '            .CustomTypeConverter = New System.ComponentModel.StringConverter
        '            .Tag2 = "PROP_MS_1"
        '            Select Case Me.SpecType
        ...
        '                Case Else
        '                    .IsReadOnly = False
        '                    .Tag = New Object() {FlowSheet.FlowsheetOptions.NumberFormat, su.pressure, "P"}
        '                    .CustomEditor = New DWSIM.Editors.Generic.UIUnitConverter
        '            End Select
        '        End With
        '        valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(0).Properties.massflow.GetValueOrDefault), FlowSheet.FlowsheetOptions.NumberFormat)
        '        .Item.Add("[4] " & FT(Me.FlowSheet.GetTranslatedString("Vazomssica"), su.massflow), valor, False, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("Vazomssicadacorrente"), True)
        '        With .Item(.Item.Count - 1)
        '            .CustomTypeConverter = New System.ComponentModel.StringConverter
        '            .Tag2 = "PROP_MS_2"
        '            .Tag = New Object() {FlowSheet.FlowsheetOptions.NumberFormat, su.massflow, "W"}
        '            .CustomEditor = New DWSIM.Editors.Generic.UIUnitConverter
        '        End With
        '        valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(0).Properties.molarflow.GetValueOrDefault), FlowSheet.FlowsheetOptions.NumberFormat)
        '        .Item.Add("[5] " & FT(Me.FlowSheet.GetTranslatedString("Vazomolar"), su.molarflow), valor, False, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("Vazomolardacorrente"), True)
        '        With .Item(.Item.Count - 1)
        '            .CustomTypeConverter = New System.ComponentModel.StringConverter
        '            .Tag2 = "PROP_MS_3"
        '            .Tag = New Object() {FlowSheet.FlowsheetOptions.NumberFormat, su.molarflow, "M"}
        '            .CustomEditor = New DWSIM.Editors.Generic.UIUnitConverter
        '        End With
        '        valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(0).Properties.volumetric_flow.GetValueOrDefault), FlowSheet.FlowsheetOptions.NumberFormat)
        '        .Item.Add("[6] " & FT(Me.FlowSheet.GetTranslatedString("Vazovolumtrica"), su.volumetricFlow), valor, False, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("Vazovolumtricadacorr"), True)
        '        With .Item(.Item.Count - 1)
        '            .CustomTypeConverter = New System.ComponentModel.StringConverter
        '            .Tag2 = "PROP_MS_4"
        '            .Tag = New Object() {FlowSheet.FlowsheetOptions.NumberFormat, su.volumetricFlow, "Q"}
        '            .CustomEditor = New DWSIM.Editors.Generic.UIUnitConverter
        '        End With

        '        Dim f As New PropertyGridEx.CustomPropertyCollection()
        '        valor = Format(Me.Phases(7).Properties.molarfraction.GetValueOrDefault, FlowSheet.FlowsheetOptions.NumberFormat)
        '        f.Add(Me.FlowSheet.GetTranslatedString("Solid"), valor, True, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("FraomolardaPhasenamis"), True) 'solid
        '        f.Item(0).IsReadOnly = True
        '        f.Item(0).Tag2 = "PROP_MS_146"
        '        valor = Format(Me.Phases(1).Properties.molarfraction.GetValueOrDefault, FlowSheet.FlowsheetOptions.NumberFormat)
        '        f.Add(Me.FlowSheet.GetTranslatedString("OverallLiquid"), valor, True, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("FraomolardaPhasenamis"), True) ' liquid
        '        f.Item(1).IsReadOnly = True
        '        valor = Format(Me.Phases(2).Properties.molarfraction.GetValueOrDefault, FlowSheet.FlowsheetOptions.NumberFormat)
        '        f.Add(Me.FlowSheet.GetTranslatedString("Vapor"), valor, True, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("FraomolardaPhasenamis"), True) 'vapour
        ...
        '        .Item.Add("[7] " & Me.FlowSheet.GetTranslatedString("FraomolardaPhase"), f, True, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("FraomolardaPhase"), True)
        '        With .Item(.Item.Count - 1)
        '            .IsReadOnly = False
        '            .IsBrowsable = True
        ...
        '        valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.enthalpy, Me.Phases(0).Properties.enthalpy.GetValueOrDefault), FlowSheet.FlowsheetOptions.NumberFormat)
        '        .Item.Add("[8] " & FT(Me.FlowSheet.GetTranslatedString("EntalpiaEspecfica"), su.enthalpy), valor, True, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("EntalpiaEspecficadam"), True)
        '        With .Item(.Item.Count - 1)
        '            .CustomTypeConverter = New System.ComponentModel.StringConverter
        '            .Tag2 = "PROP_MS_7"
        '            Select Case Me.SpecType
        ...
        '            End Select
        '        End With
        '        valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.entropy, Me.Phases(0).Properties.entropy.GetValueOrDefault), FlowSheet.FlowsheetOptions.NumberFormat)
        '        .Item.Add("[9] " & FT(Me.FlowSheet.GetTranslatedString("EntropiaEspecfica"), su.entropy), valor, True, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("EntropiaEspecficadam"), True)
        '        With .Item(.Item.Count - 1)
        '            .CustomTypeConverter = New System.ComponentModel.StringConverter
        '            .Tag2 = "PROP_MS_8"
        '            Select Case Me.SpecType
        ...
        '            End Select
        '        End With
        '        .Item.Add("[A] " & Me.FlowSheet.GetTranslatedString("EditordeComposies"), Me.Phases(0), "Compounds", False, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("UtilizeoEditordeComp"), True)
        '        If Me.GraphicObject.InputConnectors(0).IsAttached Then
        ...
        '            .Item(.Item.Count - 1).CustomEditor = New DWSIM.Editors.Composition.UICompositionEditor
        '        End If
        '        .Item.Add("[B] " & Me.FlowSheet.GetTranslatedString("Basedacomposio"), Me, "CompositionBasis", False, Me.FlowSheet.GetTranslatedString("Condies1"), Me.FlowSheet.GetTranslatedString("Selecioneabaseparaav"), True)
        ...
        '        pgrid.ExpandGroup("[7] " & Me.FlowSheet.GetTranslatedString("FraomolardaPhase"))

        '    End With

        'End Sub

        Public Overridable Sub PopulatePropertyGrid2(ByRef pg As PropertyGridEx.PropertyGridEx, ByRef Flowsheet As IFlowsheet, ByVal su As SystemsOfUnits.Units)
            ...
            With pg
                ...
                Select Case Me.CompositionBasis
                    Case Enums.CompositionBasis.Molar_Fractions
                        ...
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(0).Compounds(comp.Name).MoleFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            m.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaMistura"), True)
                        ...
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(2).Compounds(comp.Name).MoleFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            v.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseVapor"), True)
                        ...
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(1).Compounds(comp.Name).MoleFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                        ...
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(3).Compounds(comp.Name).MoleFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l1.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                        ...
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(4).Compounds(comp.Name).MoleFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l2.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                        ...
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(5).Compounds(comp.Name).MoleFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l3.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                        ...
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(6).Compounds(comp.Name).MoleFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l4.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                        ...
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(7).Compounds(comp.Name).MoleFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            s.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseSolida"), True)
                        ...
                        Next
                        .Item.Add("[1] " & Me.FlowSheet.GetTranslatedString("Mistura"), m, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Composiomolardamistu"), True)
                        With .Item(.Item.Count - 1)
                        ...
                        End With
                        If Me.Phases(2).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[2] " & Me.FlowSheet.GetTranslatedString("Vapor"), v, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[3] " & Me.FlowSheet.GetTranslatedString("OverallLiquid"), l, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas2"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(3).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[4] " & Me.FlowSheet.GetTranslatedString("Liquid1"), l1, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas2"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(4).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[5] " & Me.FlowSheet.GetTranslatedString("Liquid2"), l2, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas2"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(5).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[6] " & Me.FlowSheet.GetTranslatedString("Liquid3"), l3, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas2"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(6).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[7] " & Me.FlowSheet.GetTranslatedString("Aqueous"), l4, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas2"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(7).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[8] " & Me.FlowSheet.GetTranslatedString("Solid"), s, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas2"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                    ...
                    Case Enums.CompositionBasis.Mass_Fractions
                        ...
                        Dim comp As BaseClasses.ConstantProperties
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(0).Compounds(comp.Name).MassFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            m.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomssicanaMistura"), True)
                            m.Item(m.Count - 1).IsReadOnly = True
                            m.Item(m.Count - 1).DefaultValue = Nothing
                            m.Item(m.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim v As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(2).Compounds(comp.Name).MassFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            v.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomssicanaFaseVapo"), True)
                            v.Item(v.Count - 1).IsReadOnly = True
                            v.Item(v.Count - 1).DefaultValue = Nothing
                            v.Item(v.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(1).Compounds(comp.Name).MassFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomssicanaFaseLqui"), True)
                            l.Item(l.Count - 1).IsReadOnly = True
                            l.Item(l.Count - 1).DefaultValue = Nothing
                            l.Item(l.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l1 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(3).Compounds(comp.Name).MassFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l1.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomssicanaFaseLqui"), True)
                            l1.Item(l1.Count - 1).IsReadOnly = True
                            l1.Item(l1.Count - 1).DefaultValue = Nothing
                            l1.Item(l1.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l2 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(4).Compounds(comp.Name).MassFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l2.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomssicanaFaseLqui"), True)
                            l2.Item(l2.Count - 1).IsReadOnly = True
                            l2.Item(l2.Count - 1).DefaultValue = Nothing
                            l2.Item(l2.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l3 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(5).Compounds(comp.Name).MassFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l3.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomssicanaFaseLqui"), True)
                            l3.Item(l3.Count - 1).IsReadOnly = True
                            l3.Item(l3.Count - 1).DefaultValue = Nothing
                            l3.Item(l3.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l4 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(6).Compounds(comp.Name).MassFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l4.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomssicanaFaseLqui"), True)
                            l4.Item(l4.Count - 1).IsReadOnly = True
                            l4.Item(l4.Count - 1).DefaultValue = Nothing
                            l4.Item(l4.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim s As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(7).Compounds(comp.Name).MassFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            s.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomssicanaFaseLqui"), True)
                            s.Item(s.Count - 1).IsReadOnly = True
                            s.Item(s.Count - 1).DefaultValue = Nothing
                            s.Item(s.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        .Item.Add("[1] " & Me.FlowSheet.GetTranslatedString("Mistura"), m, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Composiomssicadamist"), True)
                        With .Item(.Item.Count - 1)
                            If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                            .IsBrowsable = True
                            .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End With
                        If Me.Phases(2).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[2] " & Me.FlowSheet.GetTranslatedString("Vapor"), v, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas3"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[3] " & Me.FlowSheet.GetTranslatedString("OverallLiquid"), l, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(3).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[4] " & Me.FlowSheet.GetTranslatedString("Liquid1"), l1, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(4).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[5] " & Me.FlowSheet.GetTranslatedString("Liquid2"), l2, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(5).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[6] " & Me.FlowSheet.GetTranslatedString("Liquid3"), l3, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(6).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[7] " & Me.FlowSheet.GetTranslatedString("Aqueous"), l4, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(7).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[8] " & Me.FlowSheet.GetTranslatedString("Solid"), s, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                    ...
                    Case Enums.CompositionBasis.Volumetric_Fractions
                        ...
                        Dim comp As BaseClasses.ConstantProperties
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(0).Compounds(comp.Name).VolumetricFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            m.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VolFractionMixture"), True)
                            m.Item(m.Count - 1).IsReadOnly = True
                            m.Item(m.Count - 1).DefaultValue = Nothing
                            m.Item(m.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim v As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(2).Compounds(comp.Name).VolumetricFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            v.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VolFractionVaporPhase"), True)
                            v.Item(v.Count - 1).IsReadOnly = True
                            v.Item(v.Count - 1).DefaultValue = Nothing
                            v.Item(v.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(1).Compounds(comp.Name).VolumetricFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VolFractionLiqPhase"), True)
                            l.Item(l.Count - 1).IsReadOnly = True
                            l.Item(l.Count - 1).DefaultValue = Nothing
                            l.Item(l.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l1 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(3).Compounds(comp.Name).VolumetricFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l1.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VolFractionLiqPhase"), True)
                            l1.Item(l1.Count - 1).IsReadOnly = True
                            l1.Item(l1.Count - 1).DefaultValue = Nothing
                            l1.Item(l1.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l2 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(4).Compounds(comp.Name).VolumetricFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l2.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VolFractionLiqPhase"), True)
                            l2.Item(l2.Count - 1).IsReadOnly = True
                            l2.Item(l2.Count - 1).DefaultValue = Nothing
                            l2.Item(l2.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l3 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(5).Compounds(comp.Name).VolumetricFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l3.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VolFractionLiqPhase"), True)
                            l3.Item(l3.Count - 1).IsReadOnly = True
                            l3.Item(l3.Count - 1).DefaultValue = Nothing
                            l3.Item(l3.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l4 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(6).Compounds(comp.Name).VolumetricFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            l4.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VolFractionLiqPhase"), True)
                            l4.Item(l4.Count - 1).IsReadOnly = True
                            l4.Item(l4.Count - 1).DefaultValue = Nothing
                            l4.Item(l4.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim s As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(7).Compounds(comp.Name).VolumetricFraction.GetValueOrDefault, Flowsheet.FlowsheetOptions.FractionNumberFormat)
                            s.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VolFractionSolPhase"), True)
                            s.Item(s.Count - 1).IsReadOnly = True
                            s.Item(s.Count - 1).DefaultValue = Nothing
                            s.Item(s.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        .Item.Add("[1] " & Me.FlowSheet.GetTranslatedString("Mistura"), m, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Composiomssicadamist"), True)
                        With .Item(.Item.Count - 1)
                            If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                            .IsBrowsable = True
                            .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End With
                        If Me.Phases(2).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[2] " & Me.FlowSheet.GetTranslatedString("Vapor"), v, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas3"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[3] " & Me.FlowSheet.GetTranslatedString("OverallLiquid"), l, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(3).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[4] " & Me.FlowSheet.GetTranslatedString("Liquid1"), l1, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(4).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[5] " & Me.FlowSheet.GetTranslatedString("Liquid2"), l2, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(5).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[6] " & Me.FlowSheet.GetTranslatedString("Liquid3"), l3, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(6).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[7] " & Me.FlowSheet.GetTranslatedString("Aqueous"), l4, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(7).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[8] " & Me.FlowSheet.GetTranslatedString("Solid"), s, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas4"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                    ...
                    Case Enums.CompositionBasis.Mass_Flows
                        ...
                        Dim comp As BaseClasses.ConstantProperties
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(0).Compounds(comp.Name).MassFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            m.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.massflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazomssicanaMistura"), True)
                            m.Item(m.Count - 1).IsReadOnly = True
                            m.Item(m.Count - 1).DefaultValue = Nothing
                            m.Item(m.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim v As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(2).Compounds(comp.Name).MassFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            v.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.massflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazomssicanaFaseVapo"), True)
                            v.Item(v.Count - 1).IsReadOnly = True
                            v.Item(v.Count - 1).DefaultValue = Nothing
                            v.Item(v.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(1).Compounds(comp.Name).MassFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.massflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazomssicanaFaseLqui"), True)
                            l.Item(l.Count - 1).IsReadOnly = True
                            l.Item(l.Count - 1).DefaultValue = Nothing
                            l.Item(l.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l1 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(3).Compounds(comp.Name).MassFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l1.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.massflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazomssicanaFaseLqui"), True)
                            l1.Item(l1.Count - 1).IsReadOnly = True
                            l1.Item(l1.Count - 1).DefaultValue = Nothing
                            l1.Item(l1.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l2 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(4).Compounds(comp.Name).MassFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l2.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.massflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazomssicanaFaseLqui"), True)
                            l2.Item(l2.Count - 1).IsReadOnly = True
                            l2.Item(l2.Count - 1).DefaultValue = Nothing
                            l2.Item(l2.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l3 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(5).Compounds(comp.Name).MassFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l3.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.massflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazomssicanaFaseLqui"), True)
                            l3.Item(l3.Count - 1).IsReadOnly = True
                            l3.Item(l3.Count - 1).DefaultValue = Nothing
                            l3.Item(l3.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l4 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(6).Compounds(comp.Name).MassFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l4.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.massflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazomssicanaFaseLqui"), True)
                            l4.Item(l4.Count - 1).IsReadOnly = True
                            l4.Item(l4.Count - 1).DefaultValue = Nothing
                            l4.Item(l4.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim s As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, Me.Phases(7).Compounds(comp.Name).MassFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            s.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.massflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazomssicanaFaseSolida"), True)
                            s.Item(s.Count - 1).IsReadOnly = True
                            s.Item(s.Count - 1).DefaultValue = Nothing
                            s.Item(s.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        .Item.Add("[1] " & Me.FlowSheet.GetTranslatedString("Mistura"), m, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Vazomssicadamistura"), True)
                        With .Item(.Item.Count - 1)
                            If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                            .IsBrowsable = True
                            .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End With
                        If Me.Phases(2).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[2] " & Me.FlowSheet.GetTranslatedString("Vapor"), v, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas5"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[3] " & Me.FlowSheet.GetTranslatedString("OverallLiquid"), l, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas6"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(3).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[4] " & Me.FlowSheet.GetTranslatedString("Liquid1"), l1, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas6"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(4).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[5] " & Me.FlowSheet.GetTranslatedString("Liquid2"), l2, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas6"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(5).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[6] " & Me.FlowSheet.GetTranslatedString("Liquid3"), l3, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas6"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(6).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[7] " & Me.FlowSheet.GetTranslatedString("Aqueous"), l4, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas6"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(7).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[8] " & Me.FlowSheet.GetTranslatedString("Solid"), s, True, Me.FlowSheet.GetTranslatedString("Composiesmssicas2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas7"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                    ...
                    Case Enums.CompositionBasis.Molar_Flows
                        ...
                        Dim comp As BaseClasses.ConstantProperties
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(0).Compounds(comp.Name).MolarFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            m.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.molarflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaMistura"), True)
                            m.Item(m.Count - 1).IsReadOnly = True
                            m.Item(m.Count - 1).DefaultValue = Nothing
                            m.Item(m.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim v As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(2).Compounds(comp.Name).MolarFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            v.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.molarflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseVapor"), True)
                            v.Item(v.Count - 1).IsReadOnly = True
                            v.Item(v.Count - 1).DefaultValue = Nothing
                            v.Item(v.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(1).Compounds(comp.Name).MolarFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.molarflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                            l.Item(l.Count - 1).IsReadOnly = True
                            l.Item(l.Count - 1).DefaultValue = Nothing
                            l.Item(l.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l1 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(3).Compounds(comp.Name).MolarFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l1.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.molarflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                            l1.Item(l1.Count - 1).IsReadOnly = True
                            l1.Item(l1.Count - 1).DefaultValue = Nothing
                            l1.Item(l1.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l2 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(4).Compounds(comp.Name).MolarFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l2.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.molarflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                            l2.Item(l2.Count - 1).IsReadOnly = True
                            l2.Item(l2.Count - 1).DefaultValue = Nothing
                            l2.Item(l2.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l3 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(5).Compounds(comp.Name).MolarFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l3.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.molarflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                            l3.Item(l3.Count - 1).IsReadOnly = True
                            l3.Item(l3.Count - 1).DefaultValue = Nothing
                            l3.Item(l3.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l4 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(6).Compounds(comp.Name).MolarFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l4.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.molarflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseLquid"), True)
                            l4.Item(l4.Count - 1).IsReadOnly = True
                            l4.Item(l4.Count - 1).DefaultValue = Nothing
                            l4.Item(l4.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim s As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, Me.Phases(7).Compounds(comp.Name).MolarFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            s.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.molarflow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("FraomolarnaFaseSolida"), True)
                            s.Item(s.Count - 1).IsReadOnly = True
                            s.Item(s.Count - 1).DefaultValue = Nothing
                            s.Item(s.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        End With
                        If Me.Phases(2).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[2] " & Me.FlowSheet.GetTranslatedString("Vapor"), v, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas7"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[3] " & Me.FlowSheet.GetTranslatedString("OverallLiquid"), l, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas8"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(3).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[4] " & Me.FlowSheet.GetTranslatedString("Liquid1"), l1, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas8"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(4).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[5] " & Me.FlowSheet.GetTranslatedString("Liquid2"), l2, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas8"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(5).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[6] " & Me.FlowSheet.GetTranslatedString("Liquid3"), l3, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas8"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(6).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[7] " & Me.FlowSheet.GetTranslatedString("Aqueous"), l4, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas8"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(7).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[8] " & Me.FlowSheet.GetTranslatedString("Solid"), s, True, Me.FlowSheet.GetTranslatedString("Composiesmolares2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas8"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                    ...
                    Case Enums.CompositionBasis.Volumetric_Flows
                        ...
                        Dim comp As BaseClasses.ConstantProperties
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(0).Compounds(comp.Name).VolumetricFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            m.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.volumetricFlow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazovolumtricanaMist"), True)
                            m.Item(m.Count - 1).IsReadOnly = True
                            m.Item(m.Count - 1).DefaultValue = Nothing
                            m.Item(m.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim v As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(2).Compounds(comp.Name).VolumetricFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            v.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.volumetricFlow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazovolumtricanaFase"), True)
                            v.Item(v.Count - 1).IsReadOnly = True
                            v.Item(v.Count - 1).DefaultValue = Nothing
                            v.Item(v.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(1).Compounds(comp.Name).VolumetricFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.volumetricFlow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazovolumtricanaFase"), True)
                            l.Item(l.Count - 1).IsReadOnly = True
                            l.Item(l.Count - 1).DefaultValue = Nothing
                            l.Item(l.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l1 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(3).Compounds(comp.Name).VolumetricFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l1.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.volumetricFlow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazovolumtricanaFase"), True)
                            l1.Item(l1.Count - 1).IsReadOnly = True
                            l1.Item(l1.Count - 1).DefaultValue = Nothing
                            l1.Item(l1.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l2 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(4).Compounds(comp.Name).VolumetricFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l2.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.volumetricFlow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazovolumtricanaFase"), True)
                            l2.Item(l2.Count - 1).IsReadOnly = True
                            l2.Item(l2.Count - 1).DefaultValue = Nothing
                            l2.Item(l2.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l3 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(5).Compounds(comp.Name).VolumetricFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l3.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.volumetricFlow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazovolumtricanaFase"), True)
                            l3.Item(l3.Count - 1).IsReadOnly = True
                            l3.Item(l3.Count - 1).DefaultValue = Nothing
                            l3.Item(l3.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim l4 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(6).Compounds(comp.Name).VolumetricFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            l4.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.volumetricFlow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazovolumtricanaFase"), True)
                            l4.Item(l4.Count - 1).IsReadOnly = True
                            l4.Item(l4.Count - 1).DefaultValue = Nothing
                            l4.Item(l4.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        ...
                        Dim s As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, Me.Phases(7).Compounds(comp.Name).VolumetricFlow.GetValueOrDefault), Flowsheet.FlowsheetOptions.NumberFormat)
                            s.Add(FT(Me.FlowSheet.GetTranslatedString(comp.Name), su.volumetricFlow), Format(valor, Flowsheet.FlowsheetOptions.NumberFormat), False, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("VazovolumtricanaFaseSolida"), True)
                            s.Item(s.Count - 1).IsReadOnly = True
                            s.Item(s.Count - 1).DefaultValue = Nothing
                            s.Item(s.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        .Item.Add("[1] " & Me.FlowSheet.GetTranslatedString("Mistura"), m, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Vazovolumtricadamist"), True)
                        With .Item(.Item.Count - 1)
                            If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                            .IsBrowsable = True
                            .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End With
                        If Me.Phases(2).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[2] " & Me.FlowSheet.GetTranslatedString("Vapor"), v, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas9"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[3] " & Me.FlowSheet.GetTranslatedString("OverallLiquid"), l, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas10"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(3).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[4] " & Me.FlowSheet.GetTranslatedString("Liquid1"), l1, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas10"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(4).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[5] " & Me.FlowSheet.GetTranslatedString("Liquid2"), l2, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas10"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(5).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[6] " & Me.FlowSheet.GetTranslatedString("Liquid3"), l3, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas10"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(6).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[7] " & Me.FlowSheet.GetTranslatedString("Aqueous"), l4, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas10"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        ...
                        End If
                        If Me.Phases(7).Properties.molarfraction.GetValueOrDefault > 0 Then
                            .Item.Add("[8] " & Me.FlowSheet.GetTranslatedString("Solid"), s, True, Me.FlowSheet.GetTranslatedString("Composiesvolumtrica2"), Me.FlowSheet.GetTranslatedString("Mostraacomposiodafas10"), True)
                            With .Item(.Item.Count - 1)
                                If Me.GraphicObject.InputConnectors(0).IsAttached Then .IsReadOnly = True
                                .IsBrowsable = True
                                .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                ...
                If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 And _
                    ...
                    For Each comp In Flowsheet.SelectedCompounds.Values
                        valor = Format(Me.Phases(0).Compounds(comp.Name).Kvalue, Flowsheet.FlowsheetOptions.NumberFormat)
                        k0.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("Kvalues"), Me.FlowSheet.GetTranslatedString("Kvalues"), True)
                    ...
                    Next
                    .Item.Add(Me.FlowSheet.GetTranslatedString("Kvalues"), k0, True, Me.FlowSheet.GetTranslatedString("ComponentDistribution"), Me.FlowSheet.GetTranslatedString("ComponentDistribution"), True)
                    With .Item(.Item.Count - 1)
                        .IsReadOnly = True
                        .IsBrowsable = True
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                    ...
                    For Each comp In Flowsheet.SelectedCompounds.Values
                        valor = Format(Me.Phases(0).Compounds(comp.Name).lnKvalue, Flowsheet.FlowsheetOptions.NumberFormat)
                        k1.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("LnKvalues"), Me.FlowSheet.GetTranslatedString("LnKvalues"), True)
                    ...
                    Next
                    .Item.Add(Me.FlowSheet.GetTranslatedString("LnKvalues"), k1, True, Me.FlowSheet.GetTranslatedString("ComponentDistribution"), Me.FlowSheet.GetTranslatedString("ComponentDistribution"), True)
                    With .Item(.Item.Count - 1)
                        .IsReadOnly = True
                        .IsBrowsable = True
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                ...
                If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 And _
                    ...
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.enthalpy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pm.Add(FT(Me.FlowSheet.GetTranslatedString("EntalpiaEspecfica"), su.enthalpy), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("EntalpiaEspecficadam"), True)
                    refval = Me.Phases(0).Properties.entropy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.entropy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pm.Add(FT(Me.FlowSheet.GetTranslatedString("EntropiaEspecfica"), su.entropy), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("EntropiaEspecficadam"), True)
                    refval = Me.Phases(0).Properties.molar_enthalpy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_enthalpy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pm.Add(FT(Me.FlowSheet.GetTranslatedString("MolarEnthalpy"), su.molar_enthalpy), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("MolarEnthalpy"), True)
                    refval = Me.Phases(0).Properties.molar_entropy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_entropy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pm.Add(FT(Me.FlowSheet.GetTranslatedString("MolarEntropy"), su.molar_entropy), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("MolarEntropy"), True)
                    refval = Me.Phases(0).Properties.molecularWeight.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molecularWeight, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pm.Add(FT(Me.FlowSheet.GetTranslatedString("Massamolar"), su.molecularWeight), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("Massamolardamistura"), True)
                    refval = Me.Phases(0).Properties.density.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.density, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pm.Add(FT(Me.FlowSheet.GetTranslatedString("Massaespecfica"), su.density), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("Massaespecficadamist"), True)
                    'refval = Me.Phases(0).Properties.massflow.GetValueOrDefault / CDbl(Me.Phases(0).Properties.density.GetValueOrDefault)
                    'If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    'pm.Add(FT(Me.FlowSheet.GetTranslatedString("VazoTP"), su.volumetricFlow), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("Vazovolumtricanascon"), True)
                    'refval = Me.Phases(0).Properties.massflow.GetValueOrDefault
                    'If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    'pm.Add(FT(Me.FlowSheet.GetTranslatedString("Vazomssica"), su.massflow), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("Vazomssicadacorrente"), True)
                    refval = Me.Phases(0).Properties.thermalConductivity.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.thermalConductivity, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pm.Add(FT(Me.FlowSheet.GetTranslatedString("Condutividadetrmica"), su.thermalConductivity), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("Condutividadetrmicad"), True)

                    If Flowsheet.FlowsheetOptions.CalculateBubbleAndDewPoints Then
                        refval = Me.Phases(0).Properties.bubblePressure.GetValueOrDefault
                        If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.pressure, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                        pm.Add(FT(Me.FlowSheet.GetTranslatedString("BubblePress"), su.pressure), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("BubblePress"), True)
                        refval = Me.Phases(0).Properties.dewPressure.GetValueOrDefault
                        If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.pressure, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                        pm.Add(FT(Me.FlowSheet.GetTranslatedString("DewPress"), su.pressure), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("DewPress"), True)
                        refval = Me.Phases(0).Properties.bubbleTemperature.GetValueOrDefault
                        If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.temperature, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                        pm.Add(FT(Me.FlowSheet.GetTranslatedString("BubbleTemp"), su.temperature), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("BubbleTemp"), True)
                        refval = Me.Phases(0).Properties.dewTemperature.GetValueOrDefault
                        If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.temperature, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                        pm.Add(FT(Me.FlowSheet.GetTranslatedString("DewTemp"), su.temperature), val, True, Me.FlowSheet.GetTranslatedString("Mistura"), Me.FlowSheet.GetTranslatedString("DewTemp"), True)
                    End If
                    ...
                    .Item.Add("[P1] " & Me.FlowSheet.GetTranslatedString("Mistura"), pm, True, Me.FlowSheet.GetTranslatedString("Propriedades3"), Me.FlowSheet.GetTranslatedString("Propriedadesdamistur"), True)
                    With .Item(.Item.Count - 1)
                        .IsBrowsable = True
                        .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                ...
                ElseIf Flowsheet.FlowsheetOptions.CalculateBubbleAndDewPoints Then
                ...
                If Me.Phases(2).Properties.molarfraction.GetValueOrDefault > 0 Then
                    ...
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.enthalpy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("EntalpiaEspecfica"), su.enthalpy), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("EntalpiaEspecficadaf"), True)
                    refval = Me.Phases(2).Properties.entropy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.entropy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("EntropiaEspecfica"), su.entropy), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("EntropiaEspecficadaf"), True)
                    refval = Me.Phases(2).Properties.molar_enthalpy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_enthalpy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("MolarEnthalpy"), su.molar_enthalpy), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("MolarEnthalpy"), True)
                    refval = Me.Phases(2).Properties.molar_entropy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_entropy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("MolarEntropy"), su.molar_entropy), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("MolarEntropy"), True)
                    refval = Me.Phases(2).Properties.molecularWeight.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molecularWeight, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("Massamolar"), su.molecularWeight), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Massamolardafasevapo"), True)
                    refval = Me.Phases(2).Properties.density.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.density, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("Massaespecfica"), su.density), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Massaespecficadafase"), True)
                    refval = Me.Phases(2).Properties.massflow.GetValueOrDefault / CDbl(Me.Phases(2).Properties.density.GetValueOrDefault)
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("VazoTP"), su.volumetricFlow), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Vazovolumtricanascon"), True)
                    refval = Me.Phases(2).Properties.massflow.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("Vazomssica"), su.massflow), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Vazomssicadacorrente"), True)
                    refval = Me.Phases(2).Properties.molarflow.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("Vazomolar"), su.molarflow), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Vazomolardacorrente"), True)
                    refval = Me.Phases(2).Properties.molarfraction.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(Me.FlowSheet.GetTranslatedString("Fraomolardafase"), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Fraomolardafasenamis"), True)
                    refval = Me.Phases(2).Properties.massfraction.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(Me.FlowSheet.GetTranslatedString("Fraomssicadafase"), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Fraomssicadafasenami"), True)
                    refval = Me.Phases(2).Properties.compressibilityFactor.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add("Z", val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Fatordecompressibili"), True)
                    refval = Me.Phases(2).Properties.heatCapacityCp.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.heatCapacityCp, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT("Cp", su.heatCapacityCp), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Capacidadecalorficad"), True)
                    ...
                    If refval.HasValue = True And Double.IsNaN(refval) = False Then tmp = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat) Else tmp = 0.0#
                    pv.Add("Cp/Cv", tmp, True, Me.FlowSheet.GetTranslatedString("lquida"), Me.FlowSheet.GetTranslatedString("Razoentreascapacidad"), True)
                    refval = Me.Phases(2).Properties.thermalConductivity.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.thermalConductivity, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("Condutividadetrmica"), su.thermalConductivity), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Condutividadetrmicad1"), True)
                    ...
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("Viscosidadecinemtica"), su.cinematic_viscosity), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Viscosidadecinemtica2"), True)
                    ...
                    pv.Add(FT(Me.FlowSheet.GetTranslatedString("Viscosidadedinmica"), su.viscosity), val, True, Me.FlowSheet.GetTranslatedString("Vapor"), Me.FlowSheet.GetTranslatedString("Viscosidadedinmicada"), True)
                    ...
                    .Item.Add("[P2] " & Me.FlowSheet.GetTranslatedString("Vapor"), pv, True, Me.FlowSheet.GetTranslatedString("Propriedades3"), Me.FlowSheet.GetTranslatedString("Propriedadesdafaseva"), True)
                    With .Item(.Item.Count - 1)
                        .IsBrowsable = True
                        .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                ...
                If Me.Phases(1).Properties.molarfraction.GetValueOrDefault > 0 Then
                    ...
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.enthalpy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("EntalpiaEspecfica"), su.enthalpy), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("EntalpiaEspecficadaf2"), True)
                    refval = Me.Phases(1).Properties.entropy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.entropy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("EntropiaEspecfica"), su.entropy), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("EntropiaEspecficadaf2"), True)
                    refval = Me.Phases(1).Properties.molar_enthalpy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_enthalpy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("MolarEnthalpy"), su.molar_enthalpy), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("MolarEnthalpy"), True)
                    refval = Me.Phases(1).Properties.molar_entropy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_entropy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("MolarEntropy"), su.molar_entropy), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("MolarEntropy"), True)
                    refval = Me.Phases(1).Properties.molecularWeight.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molecularWeight, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Massamolar"), su.molecularWeight), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Massamolardafaselqui"), True)
                    refval = Me.Phases(1).Properties.density.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.density, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Massaespecfica"), su.density), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Massaespecficadafase2"), True)
                    refval = Me.Phases(1).Properties.massflow.GetValueOrDefault / Me.Phases(1).Properties.density.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("VazoTP"), su.volumetricFlow), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Vazovolumtricanascon"), True)
                    refval = Me.Phases(1).Properties.massflow.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Vazomssica"), su.massflow), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Vazomssicadacorrente"), True)
                    refval = Me.Phases(1).Properties.molarflow.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Vazomolar"), su.molarflow), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Vazomolardacorrente"), True)
                    refval = Me.Phases(1).Properties.molarfraction.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(Me.FlowSheet.GetTranslatedString("Fraomolardafase"), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Fraomolardafasenamis"), True)
                    refval = Me.Phases(1).Properties.massfraction.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(Me.FlowSheet.GetTranslatedString("Fraomssicadafase"), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Fraomssicadafasenami"), True)
                    'refval = Me.Phases(1).Properties.compressibilityFactor.GetValueOrDefault
                    'If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    'pl.Add("Z", val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Fatordecompressibili"), True)
                    refval = Me.Phases(1).Properties.heatCapacityCp.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.heatCapacityCp, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT("Cp", su.heatCapacityCp), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Capacidadecalorficad"), True)
                    refval = Me.Phases(1).Properties.heatCapacityCp.GetValueOrDefault / Me.Phases(1).Properties.heatCapacityCv.GetValueOrDefault
                    If refval.HasValue = True And Double.IsNaN(refval) = False Then tmp = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat) Else tmp = 0.0#
                    pl.Add("Cp/Cv", tmp, True, Me.FlowSheet.GetTranslatedString("lquida"), Me.FlowSheet.GetTranslatedString("Razoentreascapacidad"), True)
                    refval = Me.Phases(0).Properties.surfaceTension.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.surfaceTension, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Tensosuperficial"), su.surfaceTension), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Tensosuperficialentr"), True)
                    refval = Me.Phases(1).Properties.thermalConductivity.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.thermalConductivity, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Condutividadetrmica"), su.thermalConductivity), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Condutividadetrmicad2"), True)
                    refval = Me.Phases(1).Properties.kinematic_viscosity.GetValueOrDefault
                    If refval.HasValue = True And Double.IsNaN(refval) = False Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.cinematic_viscosity, refval), "E")
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Viscosidadecinemtica"), su.cinematic_viscosity), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Viscosidadecinemtica2"), True)
                    refval = Me.Phases(1).Properties.viscosity.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.viscosity, refval), "E")
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Viscosidadedinmica"), su.viscosity), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Viscosidadedinmicada"), True)
                    ...
                    .Item.Add("[P3] " & Me.FlowSheet.GetTranslatedString("OverallLiquid"), pl, True, Me.FlowSheet.GetTranslatedString("Propriedades3"), Me.FlowSheet.GetTranslatedString("PropriedadesdaFaseLq"), True)
                    With .Item(.Item.Count - 1)
                        .IsBrowsable = True
                        .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                ...
                If Me.Phases(3).Properties.molarfraction.GetValueOrDefault > 0 Then
                    ...
                    If TypeOf Me.PropertyPackage Is SeawaterPropertyPackage Then
                        ...
                        val = Format(salinity, Flowsheet.FlowsheetOptions.NumberFormat)
                        pl.Add(Me.FlowSheet.GetTranslatedString("Salinity"), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Salinity"), True)
                    ...
                    If TypeOf Me.PropertyPackage Is SourWaterPropertyPackage Then
                        ...
                        If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                        pl.Add(Me.FlowSheet.GetTranslatedString("pH"), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("pH"), True)
                    ...
                    If Me.PropertyPackage.IsElectrolytePP Then
                        ...
                        Dim k0 As New PropertyGridEx.CustomPropertyCollection()
                        For Each comp In Flowsheet.SelectedCompounds.Values
                            valor = Format(Me.Phases(3).Compounds(comp.Name).ActivityCoeff, Flowsheet.FlowsheetOptions.NumberFormat)
                            k0.Add(Me.FlowSheet.GetTranslatedString(comp.Name), valor, False, Me.FlowSheet.GetTranslatedString("ActivityCoefficients"), Me.FlowSheet.GetTranslatedString("ActivityCoefficients"), True)
                            k0.Item(k0.Count - 1).IsReadOnly = True
                            k0.Item(k0.Count - 1).DefaultValue = Nothing
                            k0.Item(k0.Count - 1).DefaultType = GetType(Nullable(Of Double))
                        Next
                        pl.Add(Me.FlowSheet.GetTranslatedString("ActivityCoefficients"), k0, True, Me.FlowSheet.GetTranslatedString("ActivityCoefficients"), Me.FlowSheet.GetTranslatedString("LiquidPhaseActivityCoefficients"), True)
                        ...
                        If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                        pl.Add(Me.FlowSheet.GetTranslatedString("OsmoticCoefficient"), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("OsmoticCoefficient"), True)

                        refval = Me.Phases(3).Properties.freezingPoint.GetValueOrDefault
                        If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.temperature, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                        pl.Add(FT(Me.FlowSheet.GetTranslatedString("FreezingPoint"), su.temperature), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("FreezingPoint"), True)

                        refval = Me.Phases(3).Properties.freezingPointDepression.GetValueOrDefault
                        If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.deltaT, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                        pl.Add(FT(Me.FlowSheet.GetTranslatedString("FreezingPointDepression"), su.deltaT), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("FreezingPointDepression"), True)
                    ...
                    .Item.Add("[P4] " & Me.FlowSheet.GetTranslatedString("Liquid1"), pl, True, Me.FlowSheet.GetTranslatedString("Propriedades3"), Me.FlowSheet.GetTranslatedString("PropriedadesdaFaseLq"), True)
                    With .Item(.Item.Count - 1)
                        .IsBrowsable = True
                        .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                ...
                If Me.Phases(4).Properties.molarfraction.GetValueOrDefault > 0 Then
                    ...
                    If refval.HasValue = True And Double.IsNaN(refval) = False Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.cinematic_viscosity, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Viscosidadecinemtica"), su.cinematic_viscosity), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Viscosidadecinemtica2"), True)
                    refval = Me.Phases(4).Properties.viscosity.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.viscosity, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Viscosidadedinmica"), su.viscosity), val, True, Me.FlowSheet.GetTranslatedString("Lquido"), Me.FlowSheet.GetTranslatedString("Viscosidadedinmicada"), True)
                    ...
                    .Item.Add("[P5] " & Me.FlowSheet.GetTranslatedString("Liquid2"), pl, True, Me.FlowSheet.GetTranslatedString("Propriedades3"), Me.FlowSheet.GetTranslatedString("PropriedadesdaFaseLq"), True)
                    With .Item(.Item.Count - 1)
                        .IsBrowsable = True
                        .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                ...
                If Me.Phases(5).Properties.molarfraction.GetValueOrDefault > 0 Then
                    ...
                    .Item.Add("[P6] " & Me.FlowSheet.GetTranslatedString("Liquid3"), pl, True, Me.FlowSheet.GetTranslatedString("Propriedades3"), Me.FlowSheet.GetTranslatedString("PropriedadesdaFaseLq"), True)
                    With .Item(.Item.Count - 1)
                        .IsBrowsable = True
                        .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                ...
                If Me.Phases(6).Properties.molarfraction.GetValueOrDefault > 0 Then
                    ...
                    .Item.Add("[P7] " & Me.FlowSheet.GetTranslatedString("Aqueous"), pl, True, Me.FlowSheet.GetTranslatedString("Propriedades3"), Me.FlowSheet.GetTranslatedString("PropriedadesdaFaseLq"), True)
                    With .Item(.Item.Count - 1)
                        .IsBrowsable = True
                        .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
                ...
                If Me.Phases(7).Properties.molarfraction.GetValueOrDefault > 0 Then
                    ...
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.enthalpy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("EntalpiaEspecfica"), su.enthalpy), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("EntalpiaEspecficadaf2"), True)
                    refval = Me.Phases(7).Properties.entropy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.entropy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("EntropiaEspecfica"), su.entropy), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("EntropiaEspecficadaf2"), True)
                    refval = Me.Phases(7).Properties.molar_enthalpy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_enthalpy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("MolarEnthalpy"), su.molar_enthalpy), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("MolarEnthalpy"), True)
                    refval = Me.Phases(7).Properties.molar_entropy.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_entropy, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("MolarEntropy"), su.molar_entropy), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("MolarEntropy"), True)
                    refval = Me.Phases(7).Properties.molecularWeight.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molecularWeight, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Massamolar"), su.molecularWeight), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Massamolardafaselqui"), True)
                    refval = Me.Phases(7).Properties.density.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.density, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Massaespecfica"), su.density), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Massaespecficadafase2"), True)
                    refval = Me.Phases(7).Properties.massflow.GetValueOrDefault / Me.Phases(7).Properties.density.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.volumetricFlow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("VazoTP"), su.volumetricFlow), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Vazovolumtricanascon"), True)
                    refval = Me.Phases(7).Properties.massflow.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.massflow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Vazomssica"), su.massflow), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Vazomssicadacorrente"), True)
                    refval = Me.Phases(7).Properties.molarflow.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.molarflow, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Vazomolar"), su.molarflow), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Vazomolardacorrente"), True)
                    refval = Me.Phases(7).Properties.molarfraction.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(Me.FlowSheet.GetTranslatedString("Fraomolardafase"), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Fraomolardafasenamis"), True)
                    refval = Me.Phases(7).Properties.massfraction.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(Me.FlowSheet.GetTranslatedString("Fraomssicadafase"), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Fraomssicadafasenami"), True)
                    refval = Me.Phases(7).Properties.compressibilityFactor.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(refval, Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add("Z", val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Fatordecompressibili"), True)
                    refval = Me.Phases(7).Properties.heatCapacityCp.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.heatCapacityCp, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT("Cp", su.heatCapacityCp), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Capacidadecalorficad"), True)
                    ...
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.thermalConductivity, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Condutividadetrmica"), su.thermalConductivity), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Condutividadetrmicad2"), True)
                    refval = Me.Phases(7).Properties.kinematic_viscosity.GetValueOrDefault
                    If refval.HasValue = True And Double.IsNaN(refval) = False Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.cinematic_viscosity, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Viscosidadecinemtica"), su.cinematic_viscosity), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Viscosidadecinemtica2"), True)
                    refval = Me.Phases(7).Properties.viscosity.GetValueOrDefault
                    If refval.HasValue = True Then val = Format(SystemsOfUnits.Converter.ConvertFromSI(su.viscosity, refval), Flowsheet.FlowsheetOptions.NumberFormat)
                    pl.Add(FT(Me.FlowSheet.GetTranslatedString("Viscosidadedinmica"), su.viscosity), val, True, Me.FlowSheet.GetTranslatedString("Solid"), Me.FlowSheet.GetTranslatedString("Viscosidadedinmicada"), True)
                    ...
                    .Item.Add("[P8] " & Me.FlowSheet.GetTranslatedString("Solid"), pl, True, Me.FlowSheet.GetTranslatedString("Propriedades3"), Me.FlowSheet.GetTranslatedString("PropriedadesdaFaseSolida"), True)
                    With .Item(.Item.Count - 1)
                        .IsBrowsable = True
                        .BrowsableLabelStyle = PropertyGridEx.BrowsableTypeConverter.LabelStyle.lsEllipsis
                        .CustomEditor = New System.Drawing.Design.UITypeEditor
