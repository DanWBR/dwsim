...
namespace Yeppp
{
	...
	public partial class Math
	{
		...
		public static unsafe void Sin_V64f_V64f(double* x, double* y, int length)
		{
			...
			private unsafe delegate Status yepMath_Sin_V64f_V64f_Delegate(double* x, double* y, System.UIntPtr length);
			private static yepMath_Sin_V64f_V64f_Delegate yepMath_Sin_V64f_V64f;
