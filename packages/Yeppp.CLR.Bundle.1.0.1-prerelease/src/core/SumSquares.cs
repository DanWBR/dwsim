...
namespace Yeppp
{
	...
	public partial class Core
	{
		...
		public static unsafe double SumSquares_V64f_S64f(double* v, int length)
		{
			...
			private unsafe delegate Status yepCore_SumSquares_V32f_S32f_Delegate(float* v, out float sumSquares, System.UIntPtr length);
			private static yepCore_SumSquares_V32f_S32f_Delegate yepCore_SumSquares_V32f_S32f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_SumSquares_V64f_S64f_Delegate(double* v, out double sumSquares, System.UIntPtr length);
			private static yepCore_SumSquares_V64f_S64f_Delegate yepCore_SumSquares_V64f_S64f;
