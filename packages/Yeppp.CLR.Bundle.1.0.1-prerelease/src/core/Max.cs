...
namespace Yeppp
{
	...
	public partial class Core
	{
		...
		public static unsafe void Max_IV64fS64f_IV64f(double* x, double y, int length)
		{
			...
			private unsafe delegate Status yepCore_Max_V8s_S8s_Delegate(sbyte* v, out sbyte maximum, System.UIntPtr length);
			private static yepCore_Max_V8s_S8s_Delegate yepCore_Max_V8s_S8s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V8u_S8u_Delegate(byte* v, out byte maximum, System.UIntPtr length);
			private static yepCore_Max_V8u_S8u_Delegate yepCore_Max_V8u_S8u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V16s_S16s_Delegate(short* v, out short maximum, System.UIntPtr length);
			private static yepCore_Max_V16s_S16s_Delegate yepCore_Max_V16s_S16s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V16u_S16u_Delegate(ushort* v, out ushort maximum, System.UIntPtr length);
			private static yepCore_Max_V16u_S16u_Delegate yepCore_Max_V16u_S16u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32s_S32s_Delegate(int* v, out int maximum, System.UIntPtr length);
			private static yepCore_Max_V32s_S32s_Delegate yepCore_Max_V32s_S32s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32u_S32u_Delegate(uint* v, out uint maximum, System.UIntPtr length);
			private static yepCore_Max_V32u_S32u_Delegate yepCore_Max_V32u_S32u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64s_S64s_Delegate(long* v, out long maximum, System.UIntPtr length);
			private static yepCore_Max_V64s_S64s_Delegate yepCore_Max_V64s_S64s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64u_S64u_Delegate(ulong* v, out ulong maximum, System.UIntPtr length);
			private static yepCore_Max_V64u_S64u_Delegate yepCore_Max_V64u_S64u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32f_S32f_Delegate(float* v, out float maximum, System.UIntPtr length);
			private static yepCore_Max_V32f_S32f_Delegate yepCore_Max_V32f_S32f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64f_S64f_Delegate(double* v, out double maximum, System.UIntPtr length);
			private static yepCore_Max_V64f_S64f_Delegate yepCore_Max_V64f_S64f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V8sV8s_V8s_Delegate(sbyte* x, sbyte* y, sbyte* maximum, System.UIntPtr length);
			private static yepCore_Max_V8sV8s_V8s_Delegate yepCore_Max_V8sV8s_V8s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V8uV8u_V8u_Delegate(byte* x, byte* y, byte* maximum, System.UIntPtr length);
			private static yepCore_Max_V8uV8u_V8u_Delegate yepCore_Max_V8uV8u_V8u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V16sV16s_V16s_Delegate(short* x, short* y, short* maximum, System.UIntPtr length);
			private static yepCore_Max_V16sV16s_V16s_Delegate yepCore_Max_V16sV16s_V16s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V16uV16u_V16u_Delegate(ushort* x, ushort* y, ushort* maximum, System.UIntPtr length);
			private static yepCore_Max_V16uV16u_V16u_Delegate yepCore_Max_V16uV16u_V16u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32sV32s_V32s_Delegate(int* x, int* y, int* maximum, System.UIntPtr length);
			private static yepCore_Max_V32sV32s_V32s_Delegate yepCore_Max_V32sV32s_V32s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32uV32u_V32u_Delegate(uint* x, uint* y, uint* maximum, System.UIntPtr length);
			private static yepCore_Max_V32uV32u_V32u_Delegate yepCore_Max_V32uV32u_V32u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64sV32s_V64s_Delegate(long* x, int* y, long* maximum, System.UIntPtr length);
			private static yepCore_Max_V64sV32s_V64s_Delegate yepCore_Max_V64sV32s_V64s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64uV32u_V64u_Delegate(ulong* x, uint* y, ulong* maximum, System.UIntPtr length);
			private static yepCore_Max_V64uV32u_V64u_Delegate yepCore_Max_V64uV32u_V64u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32fV32f_V32f_Delegate(float* x, float* y, float* maximum, System.UIntPtr length);
			private static yepCore_Max_V32fV32f_V32f_Delegate yepCore_Max_V32fV32f_V32f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64fV64f_V64f_Delegate(double* x, double* y, double* maximum, System.UIntPtr length);
			private static yepCore_Max_V64fV64f_V64f_Delegate yepCore_Max_V64fV64f_V64f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V8sS8s_V8s_Delegate(sbyte* x, sbyte y, sbyte* maximum, System.UIntPtr length);
			private static yepCore_Max_V8sS8s_V8s_Delegate yepCore_Max_V8sS8s_V8s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V8uS8u_V8u_Delegate(byte* x, byte y, byte* maximum, System.UIntPtr length);
			private static yepCore_Max_V8uS8u_V8u_Delegate yepCore_Max_V8uS8u_V8u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V16sS16s_V16s_Delegate(short* x, short y, short* maximum, System.UIntPtr length);
			private static yepCore_Max_V16sS16s_V16s_Delegate yepCore_Max_V16sS16s_V16s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V16uS16u_V16u_Delegate(ushort* x, ushort y, ushort* maximum, System.UIntPtr length);
			private static yepCore_Max_V16uS16u_V16u_Delegate yepCore_Max_V16uS16u_V16u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32sS32s_V32s_Delegate(int* x, int y, int* maximum, System.UIntPtr length);
			private static yepCore_Max_V32sS32s_V32s_Delegate yepCore_Max_V32sS32s_V32s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32uS32u_V32u_Delegate(uint* x, uint y, uint* maximum, System.UIntPtr length);
			private static yepCore_Max_V32uS32u_V32u_Delegate yepCore_Max_V32uS32u_V32u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64sS32s_V64s_Delegate(long* x, int y, long* maximum, System.UIntPtr length);
			private static yepCore_Max_V64sS32s_V64s_Delegate yepCore_Max_V64sS32s_V64s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64uS32u_V64u_Delegate(ulong* x, uint y, ulong* maximum, System.UIntPtr length);
			private static yepCore_Max_V64uS32u_V64u_Delegate yepCore_Max_V64uS32u_V64u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V32fS32f_V32f_Delegate(float* x, float y, float* maximum, System.UIntPtr length);
			private static yepCore_Max_V32fS32f_V32f_Delegate yepCore_Max_V32fS32f_V32f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_V64fS64f_V64f_Delegate(double* x, double y, double* maximum, System.UIntPtr length);
			private static yepCore_Max_V64fS64f_V64f_Delegate yepCore_Max_V64fS64f_V64f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV8sV8s_IV8s_Delegate(sbyte* x, sbyte* y, System.UIntPtr length);
			private static yepCore_Max_IV8sV8s_IV8s_Delegate yepCore_Max_IV8sV8s_IV8s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV8uV8u_IV8u_Delegate(byte* x, byte* y, System.UIntPtr length);
			private static yepCore_Max_IV8uV8u_IV8u_Delegate yepCore_Max_IV8uV8u_IV8u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV16sV16s_IV16s_Delegate(short* x, short* y, System.UIntPtr length);
			private static yepCore_Max_IV16sV16s_IV16s_Delegate yepCore_Max_IV16sV16s_IV16s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV16uV16u_IV16u_Delegate(ushort* x, ushort* y, System.UIntPtr length);
			private static yepCore_Max_IV16uV16u_IV16u_Delegate yepCore_Max_IV16uV16u_IV16u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV32sV32s_IV32s_Delegate(int* x, int* y, System.UIntPtr length);
			private static yepCore_Max_IV32sV32s_IV32s_Delegate yepCore_Max_IV32sV32s_IV32s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV32uV32u_IV32u_Delegate(uint* x, uint* y, System.UIntPtr length);
			private static yepCore_Max_IV32uV32u_IV32u_Delegate yepCore_Max_IV32uV32u_IV32u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV64sV32s_IV64s_Delegate(long* x, int* y, System.UIntPtr length);
			private static yepCore_Max_IV64sV32s_IV64s_Delegate yepCore_Max_IV64sV32s_IV64s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV64uV32u_IV64u_Delegate(ulong* x, uint* y, System.UIntPtr length);
			private static yepCore_Max_IV64uV32u_IV64u_Delegate yepCore_Max_IV64uV32u_IV64u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV32fV32f_IV32f_Delegate(float* x, float* y, System.UIntPtr length);
			private static yepCore_Max_IV32fV32f_IV32f_Delegate yepCore_Max_IV32fV32f_IV32f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV64fV64f_IV64f_Delegate(double* x, double* y, System.UIntPtr length);
			private static yepCore_Max_IV64fV64f_IV64f_Delegate yepCore_Max_IV64fV64f_IV64f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV8sS8s_IV8s_Delegate(sbyte* x, sbyte y, System.UIntPtr length);
			private static yepCore_Max_IV8sS8s_IV8s_Delegate yepCore_Max_IV8sS8s_IV8s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV8uS8u_IV8u_Delegate(byte* x, byte y, System.UIntPtr length);
			private static yepCore_Max_IV8uS8u_IV8u_Delegate yepCore_Max_IV8uS8u_IV8u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV16sS16s_IV16s_Delegate(short* x, short y, System.UIntPtr length);
			private static yepCore_Max_IV16sS16s_IV16s_Delegate yepCore_Max_IV16sS16s_IV16s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV16uS16u_IV16u_Delegate(ushort* x, ushort y, System.UIntPtr length);
			private static yepCore_Max_IV16uS16u_IV16u_Delegate yepCore_Max_IV16uS16u_IV16u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV32sS32s_IV32s_Delegate(int* x, int y, System.UIntPtr length);
			private static yepCore_Max_IV32sS32s_IV32s_Delegate yepCore_Max_IV32sS32s_IV32s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV32uS32u_IV32u_Delegate(uint* x, uint y, System.UIntPtr length);
			private static yepCore_Max_IV32uS32u_IV32u_Delegate yepCore_Max_IV32uS32u_IV32u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV64sS32s_IV64s_Delegate(long* x, int y, System.UIntPtr length);
			private static yepCore_Max_IV64sS32s_IV64s_Delegate yepCore_Max_IV64sS32s_IV64s;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV64uS32u_IV64u_Delegate(ulong* x, uint y, System.UIntPtr length);
			private static yepCore_Max_IV64uS32u_IV64u_Delegate yepCore_Max_IV64uS32u_IV64u;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV32fS32f_IV32f_Delegate(float* x, float y, System.UIntPtr length);
			private static yepCore_Max_IV32fS32f_IV32f_Delegate yepCore_Max_IV32fS32f_IV32f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_Max_IV64fS64f_IV64f_Delegate(double* x, double y, System.UIntPtr length);
			private static yepCore_Max_IV64fS64f_IV64f_Delegate yepCore_Max_IV64fS64f_IV64f;
