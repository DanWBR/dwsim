...
namespace Yeppp
{
	...
	public partial class Core
	{
		...
		public static unsafe double SumAbs_V64f_S64f(double* v, int length)
		{
			...
			private unsafe delegate Status yepCore_SumAbs_V32f_S32f_Delegate(float* v, out float sumAbs, System.UIntPtr length);
			private static yepCore_SumAbs_V32f_S32f_Delegate yepCore_SumAbs_V32f_S32f;

			[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
			private unsafe delegate Status yepCore_SumAbs_V64f_S64f_Delegate(double* v, out double sumAbs, System.UIntPtr length);
			private static yepCore_SumAbs_V64f_S64f_Delegate yepCore_SumAbs_V64f_S64f;
