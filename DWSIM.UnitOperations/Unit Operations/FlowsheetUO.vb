        ...
        Public Overrides Sub PopulatePropertyGrid(ByVal pgrid As PropertyGridEx.PropertyGridEx, ByVal su As SystemsOfUnits.Units)
            ...
            With pgrid
                ...
                With .Item(.Item.Count - 1)
                    ...
                    .CustomEditor = New DWSIM.Editors.Streams.UIInputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedeentrada7"), ent7, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIInputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedeentrada8"), ent8, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIInputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedeentrada9"), ent9, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIInputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedeentrada10"), ent10, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIInputMSSelector
                End With
                ...
                With .Item(.Item.Count - 1)
                    ...
                    .CustomEditor = New DWSIM.Editors.Streams.UIOutputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedesaida5"), saida5, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIOutputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedesaida6"), saida6, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIOutputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedesaida7"), saida7, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIOutputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedesaida8"), saida8, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIOutputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedesaida9"), saida9, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIOutputMSSelector
                End With
                .Item.Add(Me.FlowSheet.GetTranslatedString("Correntedesaida10"), saida10, False, Me.FlowSheet.GetTranslatedString("Conexes1"), "", True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .CustomEditor = New DWSIM.Editors.Streams.UIOutputMSSelector
                End With

                .Item.Add(Me.FlowSheet.GetTranslatedString("SimulationFile"), Me, "SimulationFile", False, Me.FlowSheet.GetTranslatedString("Configuraes2"), Me.FlowSheet.GetTranslatedString("SimulationFileDesc"), True)
                .Item(.Item.Count - 1).CustomEditor = New PropertyGridEx.UIFilenameEditor

                If IO.File.Exists(SimulationFile) Then
                    .Item.Add(Me.FlowSheet.GetTranslatedString("FlowsheetUOEditor"), New DummyClass, False, Me.FlowSheet.GetTranslatedString("Configuraes2"), Me.FlowSheet.GetTranslatedString("FlowsheetUOEditorDesc"), True)
                    .Item(.Item.Count - 1).DefaultValue = Nothing
                    .Item(.Item.Count - 1).CustomEditor = New DWSIM.Editors.FlowsheetUO.UIFlowsheetUOEditor
                End If

                .Item.Add(Me.FlowSheet.GetTranslatedString("InitializeOnLoad"), Me, "InitializeOnLoad", False, Me.FlowSheet.GetTranslatedString("Configuraes2"), Me.FlowSheet.GetTranslatedString("InitializeOnLoadDesc"), True)
                .Item(.Item.Count - 1).Tag2 = "InitializeOnLoad"
                .Item.Add(Me.FlowSheet.GetTranslatedString("UpdateOnSave"), Me, "UpdateOnSave", False, Me.FlowSheet.GetTranslatedString("Configuraes2"), Me.FlowSheet.GetTranslatedString("UpdateOnSaveDesc"), True)
                .Item(.Item.Count - 1).Tag2 = "UpdateOnSave"
                .Item.Add(Me.FlowSheet.GetTranslatedString("RedirectOutput"), Me, "RedirectOutput", False, Me.FlowSheet.GetTranslatedString("Configuraes2"), Me.FlowSheet.GetTranslatedString("RedirectOutputDesc"), True)
                .Item(.Item.Count - 1).Tag2 = "RedirectOutput"

                If Initialized Then

                    .Item.Add(Me.FlowSheet.GetTranslatedString("FlowsheetUOViewer"), New DummyClass, False, Me.FlowSheet.GetTranslatedString("Configuraes2"), Me.FlowSheet.GetTranslatedString("FlowsheetUOViewerDesc"), True)
                    .Item(.Item.Count - 1).DefaultValue = Nothing
                    ...
                    For Each p In InputParams.Values
                        If Fsheet.Collections.FlowsheetObjectCollection.ContainsKey(p.ObjectID) Then
                            .Item.Add(Fsheet.Collections.FlowsheetObjectCollection(p.ObjectID).GraphicObject.Tag & ", " &
                                      ...
                                      Me.FlowSheet.GetTranslatedString("LinkedInputParms"), Me.FlowSheet.GetTranslatedString(""), True)
                    ...
                    For Each p In OutputParams.Values
                        If Fsheet.Collections.FlowsheetObjectCollection.ContainsKey(p.ObjectID) Then
                            .Item.Add(Fsheet.Collections.FlowsheetObjectCollection(p.ObjectID).GraphicObject.Tag & ", " &
                                      ...
                                      Me.FlowSheet.GetTranslatedString("LinkedOutputParms"), Me.FlowSheet.GetTranslatedString(""), True)
                            .Item(.Item.Count - 1).Tag = p.ID
                        End If
                    Next
                ...
                If Calculated Then
                    ...
                    .Item.Add(Me.FlowSheet.GetTranslatedString("MassBalanceError"), Format(Me.MassBalanceError, Me.FlowSheet.Options.NumberFormat), True, "5. " & Me.FlowSheet.GetTranslatedString("Resultados"), Me.FlowSheet.GetTranslatedString(""), True)
