...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Class Cooler
        ...
        Public Overrides Function Calculate(Optional ByVal args As Object = Nothing) As Integer
            ...
            Dim es As DWSIM.SimulationObjects.Streams.EnergyStream = form.Collections.FlowsheetObjectCollection(Me.GraphicObject.EnergyConnector.AttachedConnector.AttachedTo.Name)
        ...
        Public Overrides Sub PopulatePropertyGrid(ByVal pgrid As PropertyGridEx.PropertyGridEx, ByVal su As SystemsOfUnits.Units)
            ...
            With pgrid
                ...
                .Item.Add(FT(Me.FlowSheet.GetTranslatedString("Quedadepresso"), su.deltaP), Double.Parse(valor), False, Me.FlowSheet.GetTranslatedString("Parmetrosdeclculo2"), Me.FlowSheet.GetTranslatedString("Quedadepressoaplicad4"), True)
                With .Item(.Item.Count - 1)
                ...
                Select Case Me.CalcMode
                    ...
                    Case CalculationMode.HeatRemoved
                        ...
                        .Item.Add(FT(Me.FlowSheet.GetTranslatedString("CalorRemovido"), su.heatflow), Double.Parse(valor), False, Me.FlowSheet.GetTranslatedString("Parmetrosdeclculo2"), Me.FlowSheet.GetTranslatedString("Quantidadedecalorced"), True)
                        With .Item(.Item.Count - 1)
                            .CustomTypeConverter = New System.ComponentModel.StringConverter
                            .Tag2 = "PROP_CL_3"
                    ...
                    Case CalculationMode.OutletVaporFraction
                        ...
                        .Item.Add(Me.FlowSheet.GetTranslatedString("FraomolardaPhasePhaseV"), valor, False, Me.FlowSheet.GetTranslatedString("Parmetrosdeclculo2"), "", True)
                        .Item(.Item.Count - 1).Tag2 = "PROP_CL_4"

                End Select

                .Item.Add(Me.FlowSheet.GetTranslatedString("Eficincia0100"), Me, "Eficiencia", False, Me.FlowSheet.GetTranslatedString("Parmetrosdeclculo2"), Me.FlowSheet.GetTranslatedString("Eficinciadoaquecedor2"), True)
                With .Item(.Item.Count - 1)
                    .Tag2 = "PROP_CL_1"
                    .DefaultValue = Nothing
                ...
                If Me.GraphicObject.Calculated And Not Me.CalcMode = CalculationMode.HeatRemoved Then
                    valor = Format(SystemsOfUnits.Converter.ConvertFromSI(su.heatflow, Me.DeltaQ.GetValueOrDefault), FlowSheet.Options.NumberFormat)
                    .Item.Add(FT(Me.FlowSheet.GetTranslatedString("CalorRemovido"), su.heatflow), valor, True, Me.FlowSheet.GetTranslatedString("Resultados3"), Me.FlowSheet.GetTranslatedString("Quantidadedecalorced"), True)
                End If
