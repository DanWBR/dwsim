...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Class Heater
        ...
        Public Overrides Function Calculate(Optional ByVal args As Object = Nothing) As Integer
            ...
            Dim es As DWSIM.SimulationObjects.Streams.EnergyStream = Me.FlowSheet.SimulationObjects(Me.GraphicObject.InputConnectors(1).AttachedConnector.AttachedFrom.Name)
