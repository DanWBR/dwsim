            ...
            With pgrid
                ...
                Select Case Me.CalcMode
                    ...
                    Case CalculationMode.OutletPressure
                        ...
                        .Item.Add(FT(Me.FlowSheet.GetTranslatedString("Presso"), su.pressure), Double.Parse(valor), False, Me.FlowSheet.GetTranslatedString("Parmetrosdeclculo2"), Me.FlowSheet.GetTranslatedString("Pressoajusante"), True)
                        With .Item(.Item.Count - 1)
                            .CustomTypeConverter = New System.ComponentModel.StringConverter
                            .Tag2 = "PROP_CO_4"
                ...
                .Item.Add(Me.FlowSheet.GetTranslatedString("EficinciaAdiabtica01"), Me, "EficienciaAdiabatica", False, Me.FlowSheet.GetTranslatedString("Parmetrosdeclculo2"), Me.FlowSheet.GetTranslatedString("Eficinciadocompresso"), True)
                With .Item(.Item.Count - 1)
                    .Tag2 = "PROP_CO_1"
                    .DefaultValue = Nothing
                ...
                .Item.Add(Me.FlowSheet.GetTranslatedString("IgnorarLquidonaEntra"), Me, "IgnorePhase", False, Me.FlowSheet.GetTranslatedString("Parmetrosdeclculo2"), Me.FlowSheet.GetTranslatedString("SelecioLiquidrueparaign2"), True)
                With .Item(.Item.Count - 1)
                    .DefaultType = GetType(Boolean)
                End With

                .Item.Add(FT(Me.FlowSheet.GetTranslatedString("DeltaT2"), su.deltaT), Format(SystemsOfUnits.Converter.ConvertFromSI(su.deltaT, Me.DeltaT.GetValueOrDefault), Me.FlowSheet.Options.NumberFormat), True, Me.FlowSheet.GetTranslatedString("Resultados3"), Me.FlowSheet.GetTranslatedString("Diferenadetemperatur"), True)
                With .Item(.Item.Count - 1)
                    .DefaultValue = Nothing
                    .DefaultType = GetType(Nullable(Of Double))
                End With

                .Item.Add(FT(Me.FlowSheet.GetTranslatedString("EnergyFlownecessria"), su.heatflow), Format(SystemsOfUnits.Converter.ConvertFromSI(su.heatflow, Me.DeltaQ.GetValueOrDefault), Me.FlowSheet.Options.NumberFormat), True, Me.FlowSheet.GetTranslatedString("Resultados3"), Me.FlowSheet.GetTranslatedString("Potnciarequeridapelo"), True)
                With .Item(.Item.Count - 1)
                    .Tag2 = "PROP_CO_3"
                    .DefaultValue = Nothing
                    .DefaultType = GetType(Nullable(Of Double))
