...
Imports DWSIM.UnitOperations.Auxiliary.SepOps
...
Namespace UnitOperations
    ...
    <System.Serializable()> Public MustInherit Class Column
        ...
        Private m_specs As New Collections.Generic.Dictionary(Of String, ColumnSpec)
            ...
            For i = 0 To Me.NumberOfStages - 1
                ...
                Select Case Me.ColumnType
                    Case ColType.DistillationColumn
                        If i = 0 Then
                            _st(_st.Count - 1).Name = Me.FlowSheet.GetTranslatedString("DCCondenser")
                        ElseIf i = Me.NumberOfStages - 1 Then
                            _st(_st.Count - 1).Name = Me.FlowSheet.GetTranslatedString("DCReboiler")
                        Else
                            _st(_st.Count - 1).Name = Me.FlowSheet.GetTranslatedString("DCStage") & "_" & _st.Count - 1
                        End If
        ...
        Public Overrides Function Calculate(Optional ByVal args As Object = Nothing) As Integer
            ...
            For Each sp As Auxiliary.SepOps.ColumnSpec In Me.Specs.Values
                ...
                sp.SType = ColumnSpec.SpecType.Component_Recovery Then
                    i = 0
                    For Each comp As Interfaces.ICompound In stream.Phases(0).Compounds.Values
                ...
                Select Case sinf.StreamBehavior
                    Case StreamInformation.Behavior.Distillate
                        ...
                        With msm
                            ...
                            i = 0
                            For Each subst As Interfaces.ICompound In .Phases(0).Compounds.Values
                    ...
                    Select Case Me.CondenserType
                        Case condtype.Total_Condenser
                            If Not feedok Or Not cmok Or Not rmok Or Not ceok Or Not reok Then
                                Throw New Exception(Me.FlowSheet.GetTranslatedString("DCConnectionMissingException"))
