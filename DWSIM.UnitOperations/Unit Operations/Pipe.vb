    ...
    <System.Serializable()> Public Class Pipe
        ...
        Public Overrides Function Calculate(Optional ByVal args As Object = Nothing) As Integer
            ...
            If Not Me.GraphicObject.EnergyConnector.IsAttached Then
                ...
                Throw New Exception(Me.FlowSheet.GetTranslatedString("NohcorrentedeEnergyFlow3"))
            ElseIf Not Me.Profile.Status = PipeEditorStatus.OK Then
                ...
                Throw New Exception(Me.FlowSheet.GetTranslatedString("Operfilhidrulicodatu"))
            ...
            If Me.Specification = specmode.OutletPressure Then
                If Me.Profile.Sections.Count > 1 Then
                    Throw New Exception(Me.FlowSheet.GetTranslatedString("PipeOutletPressureRestriction"))
            ...
            Select Case Me.SelectedFlowPackage
                ...
                Case FlowPackage.Petalas_Aziz
                    ...
                    Else
                        FlowSheet.WriteToLog("'Petalas-Aziz' model not available in 64-bit mode. Falling back to 'Beggs & Brill'...", Color.Blue, DWSIM.Flowsheet.MessageType.Warning)
            ...
            Do
                ...
                oms = Me.FlowSheet.SimulationObjects(Me.GraphicObject.InputConnectors(0).AttachedConnector.AttachedFrom.Name).Clone()
                        ...
                        Do
                            ...
                            Do
                                ...
                                Do
                                    ...
                                    If Pout <= 0 Then Throw New Exception(Me.FlowSheet.GetTranslatedString("Pressonegativadentro"))

                                    If Double.IsNaN(Pout) Then Throw New Exception(Me.FlowSheet.GetTranslatedString("Erronoclculodapresso"))

                                    If cntP > Me.MaxPressureIterations Then Throw New Exception(Me.FlowSheet.GetTranslatedString("Ocalculadorexcedeuon"))
                                    ...
                                    If Not Me.ThermalProfile.Tipo = Editors.PipeEditor.ThermalProfileType.Definir_Q Then
                                        ...
                                        If U <> 0.0# Then
                                            ...
                                            If Not Double.TryParse(Tout, New Double) Or Double.IsNaN(Tout) Or Tout < 100 Or Tout > 1000 Then
                                                Throw New Exception(Me.FlowSheet.GetTranslatedString("Erroaocalculartemper"))
                                            End If
                                        Else
                                            Tout = Tin
                                        End If
                                ...
                                If Tout <= 0 Or Double.IsNaN(Tout) Then
                                    Throw New Exception(Me.FlowSheet.GetTranslatedString("Erronoclculodatemper"))
                                End If

                                If cntT > Me.MaxPressureIterations Then Throw New Exception(Me.FlowSheet.GetTranslatedString("Ocalculadorexcedeuon"))
                    ...
                    Else
                        ...
                        With segmento
                            ...
                            With results
                                ...
                                .DpPorHidrostatico = dph
                                .HoldupDeLiquido = holdup
                                .TipoFluxo = Me.FlowSheet.GetTranslatedString("Turbulento")
                                .TipoFluxoDescricao = ""
                ...
                If Me.Specification = specmode.OutletTemperature Then
                    ...
                    Else
                        ...
                        If countext > 2 Then
                            ...
                            If Double.IsNaN(x) Or Double.IsInfinity(x) Then Throw New Exception(Me.FlowSheet.GetTranslatedString("Erroaocalculartemper"))
                ...
                ElseIf Me.Specification = specmode.OutletPressure Then
                    ...
                    Else
                        ...
                        If countext > 2 Then
                            x = x - fx * (x - x00) / (fx - fx00)
                            If Double.IsNaN(x) Or Double.IsInfinity(x) Then Throw New Exception(Me.FlowSheet.GetTranslatedString("Erronoclculodapresso"))
...
#Region "        Funções"
        ...
        Function rugosidade(ByVal material As String) As Double
            ...
            If material = Me.FlowSheet.GetTranslatedString("AoComum") Then epsilon = 0.0000457
            If material = Me.FlowSheet.GetTranslatedString("AoCarbono") Then epsilon = 0.000045
            If material = Me.FlowSheet.GetTranslatedString("FerroBottomido") Then epsilon = 0.000259
            If material = Me.FlowSheet.GetTranslatedString("AoInoxidvel") Then epsilon = 0.000045
        ...
        Function k_parede(ByVal material As String, ByVal T As Double) As Double
            ...
            If material = Me.FlowSheet.GetTranslatedString("AoComum") Then kp = -0.000000004 * T ^ 3 - 0.00002 * T ^ 2 + 0.021 * T + 33.743
            If material = Me.FlowSheet.GetTranslatedString("AoCarbono") Then kp = 0.000000007 * T ^ 3 - 0.00002 * T ^ 2 - 0.0291 * T + 70.765
            If material = Me.FlowSheet.GetTranslatedString("FerroBottomido") Then kp = -0.00000008 * T ^ 3 + 0.0002 * T ^ 2 - 0.211 * T + 127.99
            If material = Me.FlowSheet.GetTranslatedString("AoInoxidvel") Then kp = 0.000000005 * T ^ 3 - 0.00001 * T ^ 2 + 0.024 * T ^ +8.6226
...
START_LOOP:
            ...
            'If Tinf > Tsup Then Throw New Exception(Me.FlowSheet.GetTranslatedString("Erroaocalculartemper"))
            Tsup = Tinf
            Tinf = Tinf - delta_T
