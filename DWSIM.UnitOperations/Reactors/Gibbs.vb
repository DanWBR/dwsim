...
#Region "Auxiliary Subs"
        ...
        Public Sub CreateElementMatrix()
            ...
            For Each sn As String In Me.ComponentIDs
                For Each el As String In Me.FlowSheet.Options.SelectedComponents(sn).Elements.Keys
            ...
            For i = 0 To els
                sum_e = 0
                For j = 0 To c
                    If Me.FlowSheet.Options.SelectedComponents(Me.ComponentIDs(j)).Elements.ContainsKey(Me.Elements(i)) Then
                        Me.ElementMatrix(i, j) = Me.FlowSheet.Options.SelectedComponents(Me.ComponentIDs(j)).Elements(Me.Elements(i))
                    Else
        ...
        Public Overrides Sub PopulatePropertyGrid(ByVal pgrid As PropertyGridEx.PropertyGridEx, ByVal su As SystemsOfUnits.Units)
            ...
            With pgrid
                ...
                If Me.GraphicObject.Calculated Then
                    ...
                    .Item.Add(FT(DWSIM.App.GetLocalString("RGInitialG"), su.heatflow), Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_enthalpy, Me.InitialGibbsEnergy), FlowSheet.Options.NumberFormat), True, DWSIM.App.GetLocalString("Resultados3"), DWSIM.App.GetLocalString("RGInitialG_description"), True)
                    .Item.Add(FT(DWSIM.App.GetLocalString("RGFinalG"), su.heatflow), Format(SystemsOfUnits.Converter.ConvertFromSI(su.molar_enthalpy, Me.FinalGibbsEnergy), FlowSheet.Options.NumberFormat), True, DWSIM.App.GetLocalString("Resultados3"), DWSIM.App.GetLocalString("RGFinalG_description"), True)
