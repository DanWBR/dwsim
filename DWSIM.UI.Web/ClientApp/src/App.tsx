...
class App extends React.Component<{}, IAppState> {
  ...
  constructor(props: any) {
    super(props);
    this.state = { baseFolder: undefined, isLoaded: false, siteId:"",flowsheetsDriveId:"", flowsheetsListId:"" };
  }
  ...
  render() {
    const { baseFolder, isLoaded, siteId, flowsheetsListId, flowsheetsDriveId } = this.state;
