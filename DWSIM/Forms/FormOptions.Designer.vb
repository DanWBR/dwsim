...
Partial Class FormOptions
    ...
    Private Sub InitializeComponent()
        ...
        Me.tbConfigDir = New System.Windows.Forms.TextBox()
        ...
        'btnClearDir
        '
        resources.ApplyResources(Me.btnClearDir, "btnClearDir")
        Me.btnClearDir.Name = "btnClearDir"
        Me.btnClearDir.UseVisualStyleBackColor = True
        '
        'tbConfigDir
        '
        resources.ApplyResources(Me.tbConfigDir, "tbConfigDir")
        Me.tbConfigDir.Name = "tbConfigDir"
        Me.tbConfigDir.ReadOnly = True
        '
        'GroupBox3
        '
