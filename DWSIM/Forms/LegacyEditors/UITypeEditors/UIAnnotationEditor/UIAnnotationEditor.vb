    ...
    <System.Serializable()> Public Class UIAnnotationEditor
        ...
        Public Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            ...
            If (editorService IsNot Nothing) Then
                ...
                selectionControl.rtftext = form.SimulationObjects(form.FormSurface.FlowsheetSurface.SelectedObject.Name).Annotation
                selectionControl.Text = DWSIM.App.GetLocalString("editanot") & form.FormSurface.FlowsheetSurface.SelectedObject.Tag & "..."

                editorService.ShowDialog(selectionControl)

                value = selectionControl.RichTextBoxExtended1.rtb1.Text
