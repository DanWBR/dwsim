'    UISTHXEditor for Shell and Tube Heat Exchanger
...
Namespace DWSIM.Editors.HeatExchanger

    <System.Serializable()> Public Class UISTHXEditor
        ...
        Public Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            ...
            If (editorService IsNot Nothing) Then
                ...
                Dim selectionControl As New UnitOperations.EditingForm_HeatExchanger_SHProperties

                selectionControl.hx = My.Application.ActiveSimulation.GetSelectedFlowsheetSimulationObject("")
