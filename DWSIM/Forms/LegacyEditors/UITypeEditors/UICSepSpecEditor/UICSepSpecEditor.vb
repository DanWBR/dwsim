    ...
    <System.Serializable()> Public Class UICSepSpecEditor
        ...
        Public Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            ...
            If (editorService IsNot Nothing) Then
                ...
                selectionControl.compspecs = form.SimulationObjects(form.FormSurface.FlowsheetSurface.SelectedObject.Name).ComponentSepSpecs

                selectionControl.Text = form.FormSurface.FlowsheetSurface.SelectedObject.Tag & " - " & DWSIM.App.GetLocalString("EditCompSpecs")
