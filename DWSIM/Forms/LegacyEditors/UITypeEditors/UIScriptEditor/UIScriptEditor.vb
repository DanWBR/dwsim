        ...
        Public Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            ...
            If (editorService IsNot Nothing) Then
                ...
                If Not DWSIM.App.IsRunningOnMono Then
                    ...
                    Dim obj = form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name)
                    If ctx.CustomProperty.Tag Is Nothing Then
                        With form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name)
                    ...
                    End If
                    selectionControl.Text = form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Tag & " - " & DWSIM.App.GetLocalString("ScriptEditor")
                ...
                Else
                    ...
                    Dim obj = form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name)
                    If ctx.CustomProperty.Tag Is Nothing Then
                        selectionControl.scripttext = form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name).ScriptText
                        selectionControl.language = form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name).Language
                        selectionControl.fontname = form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name).FontName
                        selectionControl.fontsize = form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name).FontSize
                        selectionControl.includes = form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name).Includes
                    Else
                        If ctx.CustomProperty.Tag = "B" Then selectionControl.scripttext = obj.ScriptExt_ScriptTextB
                        If ctx.CustomProperty.Tag = "A" Then selectionControl.scripttext = obj.ScriptExt_ScriptTextA
                    ...
                    editorService.ShowDialog(selectionControl)
                    If ctx.CustomProperty.Tag Is Nothing Then
                        form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name).FontName = selectionControl.tscb1.SelectedItem
                        form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name).FontSize = selectionControl.tscb2.SelectedItem
                        form.SimulationObjects(form.FormSurface.FlowsheetDesignSurface.FlowsheetSurface.SelectedObject.Name).Includes = selectionControl.includes
                    Else
                        obj.ScriptExt_FontName = selectionControl.tscb1.SelectedItem
                        obj.ScriptExt_FontSize = selectionControl.tscb2.SelectedItem
                        obj.ScriptExt_Includes = selectionControl.includes
