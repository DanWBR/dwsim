    ...
    <System.Serializable()> Public Class UIReactionSetSelector
        ...
        Public Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            ...
            If (editorService IsNot Nothing) Then
                ...
                If form.SimulationObjects(form.FormSurface.FlowsheetSurface.SelectedObject.Name).GraphicObject.ObjectType = ObjectType.CapeOpenUO Then
                    Me.selectedRSID = CType(form.SimulationObjects(form.FormSurface.FlowsheetSurface.SelectedObject.Name), CapeOpenUO).ReactionSetID
                Else
                    Me.selectedRSID = CType(form.SimulationObjects(form.FormSurface.FlowsheetSurface.SelectedObject.Name), Reactor).ReactionSetID
                End If
        ...
        Private Sub ListView2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListView2.SelectedIndexChanged
            If Me.loaded Then
                If Me.ListView2.SelectedItems.Count > 0 Then
                    ...
                    If form.SimulationObjects(form.FormSurface.FlowsheetSurface.SelectedObject.Name).GraphicObject.ObjectType = ObjectType.CapeOpenUO Then
                        CType(form.SimulationObjects(form.FormSurface.FlowsheetSurface.SelectedObject.Name), CapeOpenUO).ReactionSetID = Me.selectedRSID
                    Else
                        CType(form.SimulationObjects(form.FormSurface.FlowsheetSurface.SelectedObject.Name), Reactor).ReactionSetID = Me.selectedRSID
                    End If
