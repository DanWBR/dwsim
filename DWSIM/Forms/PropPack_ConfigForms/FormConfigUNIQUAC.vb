...
gt1:        If ppu.m_uni.InteractionParameters.ContainsKey(cp.Name) Then
        ...
        For Each r As DataGridViewRow In dgvu1.Rows
            ...
            cb.Items.Clear()
            Dim ipsets As List(Of DWSIM.Thermodynamics.BaseClasses.InteractionParameter) = DWSIM.Databases.UserIPDB.GetStoredIPsets(r.Cells(0).Value, r.Cells(1).Value, "UNIQUAC")
