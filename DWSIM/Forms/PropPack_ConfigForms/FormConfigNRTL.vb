...
gt1:        If ppu.m_uni.InteractionParameters.ContainsKey(cp.Name) Then
        ...
        For Each r As DataGridViewRow In dgvu1.Rows
            ...
            cb.Items.Clear()
            Dim ipsets As List(Of DWSIM.Thermodynamics.BaseClasses.InteractionParameter) = DWSIM.Databases.UserIPDB.GetStoredIPsets(r.Cells(0).Value, r.Cells(1).Value, "NRTL")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click, Button2.Click, Button5.Click, Button6.Click
        ...
        If Not chkTdep.Checked Then
            ...
            Try
                ...
                If sender.Name = "Button1" Then
                    ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation @ T = " & Format(T1, "N2") & " K using UNIFAC finished, average activity coefficient error = " & Format(avgerr, "N2") & "%.", Color.Blue, DWSIM.Flowsheet.MessageType.Information)
                ElseIf sender.Name = "Button5" Then
                    ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation @ T = " & Format(T1, "N2") & " K using UNIFAC-LL finished, average activity coefficient error = " & Format(avgerr, "N2") & "%.", Color.Blue, DWSIM.Flowsheet.MessageType.Information)
                ElseIf sender.Name = "Button6" Then
                    ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation @ T = " & Format(T1, "N2") & " K using NIST-MODFAC finished, average activity coefficient error = " & Format(avgerr, "N2") & "%.", Color.Blue, DWSIM.Flowsheet.MessageType.Information)
                Else
                    ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation @ T = " & Format(T1, "N2") & " K using MODFAC finished, average activity coefficient error = " & Format(avgerr, "N2") & "%.", Color.Blue, DWSIM.Flowsheet.MessageType.Information)
                End If
            ...
            Catch ex As Exception
                ...
                ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation finished with an error: " & ex.ToString, Color.Red, DWSIM.Flowsheet.MessageType.Information)
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        If e.Error Is Nothing Then
            ...
            If e.Result(9) = "Button1" Then
                ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation from " & Format(e.Result(7), "N2") & " to " & Format(e.Result(8), "N2") & " K using UNIFAC finished, average activity coefficient error = " & Format(e.Result(6), "N2") & "%.", Color.Blue, DWSIM.Flowsheet.MessageType.Information)
            ElseIf e.Result(9) = "Button5" Then
                ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation from " & Format(e.Result(7), "N2") & " to " & Format(e.Result(8), "N2") & " K using UNIFAC-LL finished, average activity coefficient error = " & Format(e.Result(6), "N2") & "%.", Color.Blue, DWSIM.Flowsheet.MessageType.Information)
            Else
                ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation from " & Format(e.Result(7), "N2") & " to " & Format(e.Result(8), "N2") & " K using MODFAC finished, average activity coefficient error = " & Format(e.Result(6), "N2") & "%.", Color.Blue, DWSIM.Flowsheet.MessageType.Information)
            End If
        ...
        Else
            ...
            ppu.CurrentMaterialStream.Flowsheet.WriteToLog("NRTL interaction parameter estimation from " & Format(e.Result(7), "N2") & " to " & Format(e.Result(8), "N2") & " K using MODFAC finished with an error: " & e.Error.ToString, Color.Red, DWSIM.Flowsheet.MessageType.Information)
