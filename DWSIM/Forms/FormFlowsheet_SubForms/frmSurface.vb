...
Public Class frmSurface
    ...
    Sub MaterialStreamClickHandler(ByVal sender As System.Object, ByVal e As ToolStripItemClickedEventArgs)
        ...
        CalculateObject(Flowsheet, obj1.Name)
        ...
        If Not Me.FlowsheetDesignSurface.SelectedObject Is Nothing Then
            If Me.FlowsheetDesignSurface.SelectedObject.ObjectType = ObjectType.MaterialStream Then
                ...
                ElseIf mystr.GraphicObject.InputConnectors(0).IsAttached Then
                    If mystr.GraphicObject.InputConnectors(0).AttachedConnector.AttachedFrom.ObjectType = ObjectType.OT_Recycle Then
                        editable = True
                    End If
                End If
                ...
                If editable Then
                    ...
                    With objargs
                        ...
                        .Name = mystr.Name
                        .ObjectType = mystr.GraphicObject.ObjectType
                        .Sender = "PropertyGrid"
                    End With
        ...
        If Not Me.FlowsheetDesignSurface.SelectedObject Is Nothing Then
            Select Case Me.FlowsheetDesignSurface.SelectedObject.ObjectType
                ...
                Case ObjectType.AbsorptionColumn, ObjectType.DistillationColumn, ObjectType.ReboiledAbsorber, ObjectType.RefluxedAbsorber
                    Dim myobj As DWSIM.SimulationObjects.UnitOperations.Column = Flowsheet.Collections.FlowsheetObjectCollection(Flowsheet.FormSurface.FlowsheetDesignSurface.SelectedObject.Name)
                    If My.Computer.Keyboard.ShiftKeyDown Then
                    ...
                    End If
                Case ObjectType.Pipe
                    Dim myobj As DWSIM.SimulationObjects.UnitOperations.Pipe = Flowsheet.Collections.FlowsheetObjectCollection(Flowsheet.FormSurface.FlowsheetDesignSurface.SelectedObject.Name)
                    If My.Computer.Keyboard.ShiftKeyDown Then
