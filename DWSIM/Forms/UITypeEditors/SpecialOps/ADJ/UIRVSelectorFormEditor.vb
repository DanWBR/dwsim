...
Namespace DWSIM.Editors.SpecialOps
    ...
    <System.Serializable()> Public Class UIRVSelectorEditor
        ...
        Public Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            ...
            If (editorService IsNot Nothing) Then
                ...
                selectionControl.selectionDataCV = CType(form.Collections.ObjectCollection(form.FormSurface.FlowsheetDesignSurface.SelectedObject.Name), DWSIM.SimulationObjects.SpecialOps.Adjust).ControlledObjectData
                selectionControl.gi = context

                editorService.ShowDialog(selectionControl)

                value = selectionControl.selectionDataRV
