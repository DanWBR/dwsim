Public Class ThermalProfileEditorForm
    ...
    Private Sub ThermalProfileEditorForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            With Me.ThermalProfile
                ...
                Me.TextBoxCGTC.Text = SystemsOfUnits.Converter.ConvertFromSI(su.heat_transf_coeff, .CGTC_Definido).ToString()
                Me.TextBoxCT.Text = SystemsOfUnits.Converter.ConvertFromSI(su.heatflow, .Calor_trocado).ToString()
                Me.TextBoxCTERM.Text = SystemsOfUnits.Converter.ConvertFromSI(su.thermalConductivity, .Condtermica).ToString()
                Me.TextBoxESP.Text = SystemsOfUnits.Converter.ConvertFromSI(su.thickness, .Espessura).ToString()
                Me.TextBoxTA.Text = SystemsOfUnits.Converter.ConvertFromSI(su.temperature, .Temp_amb_definir).ToString()
                Me.TextBoxTA2.Text = SystemsOfUnits.Converter.ConvertFromSI(su.temperature, .Temp_amb_estimar).ToString()
    ...
    Private Sub TextBoxCGTC_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxCGTC.TextChanged
        Try
            Me.ThermalProfile.CGTC_Definido = SystemsOfUnits.Converter.ConvertToSI(su.heat_transf_coeff, Double.Parse(Me.TextBoxCGTC.Text))
    ...
    Private Sub TextBoxTA_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxTA.TextChanged
        Try
            Me.ThermalProfile.Temp_amb_definir = SystemsOfUnits.Converter.ConvertToSI(su.temperature, Double.Parse(Me.TextBoxTA.Text))
    ...
    Private Sub TextBoxCT_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxCT.TextChanged
        Try
            Me.ThermalProfile.Calor_trocado = SystemsOfUnits.Converter.ConvertToSI(su.heatflow, Double.Parse(Me.TextBoxCT.Text))
    ...
    Private Sub TextBoxTA2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxTA2.TextChanged
        Try
            Me.ThermalProfile.Temp_amb_estimar = SystemsOfUnits.Converter.ConvertToSI(su.temperature, Double.Parse(Me.TextBoxTA2.Text))
    ...
    Private Sub TextBoxCTERM_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxCTERM.TextChanged
        Try
            Me.ThermalProfile.Condtermica = SystemsOfUnits.Converter.ConvertToSI(su.thermalConductivity, Double.Parse(Me.TextBoxCTERM.Text))
    ...
    Private Sub TextBoxESP_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxESP.TextChanged
        Try
            Me.ThermalProfile.Espessura = SystemsOfUnits.Converter.ConvertToSI(su.thickness, Double.Parse(Me.TextBoxESP.Text))
