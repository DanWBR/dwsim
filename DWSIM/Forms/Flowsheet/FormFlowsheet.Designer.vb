...
Partial Class FormFlowsheet
    ...
    Private Sub InitializeComponent()
        ...
        Me.ScriptsToolStripMenuItem.MergeIndex = 5
        ...
        Me.ResultadosToolStripMenuItem.MergeIndex = 6
