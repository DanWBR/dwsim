...
Public Class FormPureComp
    ...
    Sub Populate()
        ...
        With Me.GridProps.Rows
            ...
            .Add(New Object() {"Single-Point Solid Density", Format(SystemsOfUnits.Converter.ConvertFromSI(su.temperature, constprop.SolidTs), nf), su.temperature})
            .Add(New Object() {"Reference Temperature for Single-Point Solid Density", Format(SystemsOfUnits.Converter.ConvertFromSI(su.density, constprop.SolidDensityAtTs), nf), su.density})
