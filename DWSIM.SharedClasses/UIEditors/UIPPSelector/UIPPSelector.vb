'    UITypeEditor for Property Package Selection
...
Namespace DWSIM.Editors.PropertyPackages
    ...
    <System.Serializable()> Public Class UIPPSelector
        ...
        Public selectedPPID As String = ""
        Public selectedPPTag As String = ""
        ...
        Public Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            ...
            If (editorService IsNot Nothing) Then
                ...
                Me.ColumnHeader3.AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent)
                Me.ColumnHeader3.Width = Me.ListView2.Width

                Me.ListView2.Items.Clear()
                For Each pp As IPropertyPackage In form.PropertyPackages.Values
                    Dim lvi As New ListViewItem()
                    With lvi
                        .Text = pp.Tag & " (" & DirectCast(pp, CapeOpen.ICapeIdentification).ComponentName & ")"
                        .Tag = pp.UniqueID
                        .Name = pp.UniqueID
                    End With
                ...
                Me.ListView2.Columns(0).AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent)
                Me.ListView2.Width = Me.ListView2.Columns(0).Width + 30

                Me.loaded = True

                editorService.DropDownControl(ListView2)

                value = Me.selectedPPID
        ...
        Private Sub ListView2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListView2.SelectedIndexChanged
            If Me.loaded Then
                If Me.ListView2.SelectedItems.Count > 0 Then
                    Me.selectedPPID = Me.ListView2.SelectedItems(0).Name
                    Me.selectedPPTag = Me.ListView2.SelectedItems(0).Text
